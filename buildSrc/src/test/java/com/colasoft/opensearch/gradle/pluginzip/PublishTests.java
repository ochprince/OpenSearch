...
package com.colasoft.opensearch.gradle.pluginzip;
...
import com.colasoft.opensearch.gradle.test.GradleUnitTestCase;
...
public class PublishTests extends GradleUnitTestCase {
    ...
    public void applyZipPublicationPluginNoConfig() {
        ...
        assertNotNull(
            ...
            project.getPlugins().findPlugin(com.colasoft.opensearch.gradle.pluginzip.Publish.class)
        );
        assertNotNull(
    ...
    public void missingGroupValue() throws IOException, URISyntaxException, XmlPullParserException {
        ...
        assertEquals(model.getGroupId(), "com.colasoft.opensearch.plugin");
    ...
    public void allProjectsGroup() throws IOException, URISyntaxException, XmlPullParserException {
        ...
        assertEquals(model.getVersion(), "2.0.0.0");
        assertEquals(model.getGroupId(), "com.colasoft.opensearch");
    }
