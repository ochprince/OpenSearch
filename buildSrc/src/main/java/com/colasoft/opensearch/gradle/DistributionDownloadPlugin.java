...
import com.colasoft.opensearch.gradle.OpenSearchDistribution.Platform;
import com.colasoft.opensearch.gradle.OpenSearchDistribution.Type;
...
import com.colasoft.opensearch.gradle.transform.SymbolicLinkPreservingUntarTransform;
import com.colasoft.opensearch.gradle.transform.UnzipTransform;
    ...
    private String dependencyNotation(OpenSearchDistribution distribution) {
        ...
        if (distribution.getType() == Type.INTEG_TEST_ZIP) {
            if (distroVersion.onOrAfter("1.0.0")) {
                return "com.colasoft.opensearch.distribution.integ-test-zip:opensearch:" + distribution.getVersion() + "@zip";
            } else {
