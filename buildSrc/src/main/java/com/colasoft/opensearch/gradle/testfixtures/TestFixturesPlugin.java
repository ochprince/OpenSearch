...
package com.colasoft.opensearch.gradle.testfixtures;
...
import com.colasoft.opensearch.gradle.precommit.TestingConventionsTasks;
...
public class TestFixturesPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        maybeSkipTasks(tasks, dockerSupport, getTaskClass("com.colasoft.opensearch.gradle.test.RestIntegTestTask"));
        maybeSkipTasks(tasks, dockerSupport, TestingConventionsTasks.class);
        maybeSkipTasks(tasks, dockerSupport, getTaskClass("com.colasoft.opensearch.gradle.test.AntFixture"));
