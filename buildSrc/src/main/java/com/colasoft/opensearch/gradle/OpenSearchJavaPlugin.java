...
import com.colasoft.opensearch.gradle.precommit.PrecommitTaskPlugin;
...
import static com.colasoft.opensearch.gradle.util.Util.toStringable;
        ...
        Consumer<String> disableTransitiveDeps = configName -> {
            ...
            config.getDependencies().all(dep -> {
                if (dep instanceof ModuleDependency
                    ...
                    && dep.getGroup().startsWith("com.colasoft.opensearch") == false) {
