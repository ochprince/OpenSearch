    ...
    static void setupDependencies(Project project, SourceSet sourceSet) {
        if (BuildParams.isInternal()) {
            ...
            project.getDependencies()
                .add(sourceSet.getImplementationConfigurationName(), "com.colasoft.opensearch.test:framework:" + VersionProperties.getOpenSearch());
            // The log4j-core is optional dependency of the com.colasoft.opensearch.test:framework. needs explicit introduction
            project.getDependencies()
                .add(
