 ...
 * under the License.
 */
package com.colasoft.opensearch.gradle.plugin

import com.github.jengelman.gradle.plugins.shadow.ShadowPlugin
import org.gradle.api.tasks.bundling.AbstractArchiveTask
import com.colasoft.opensearch.gradle.BuildPlugin
import com.colasoft.opensearch.gradle.NoticeTask
import com.colasoft.opensearch.gradle.Version
import com.colasoft.opensearch.gradle.VersionProperties
import com.colasoft.opensearch.gradle.dependencies.CompileOnlyResolvePlugin
import com.colasoft.opensearch.gradle.info.BuildParams
import com.colasoft.opensearch.gradle.test.RestTestBasePlugin
import com.colasoft.opensearch.gradle.testclusters.RunTask
    ...
    void apply(Project project) {
        ...
        project.tasks.named('testingConventions').configure {
            ...
            naming {
                ...
                IT {
                    baseClass 'com.colasoft.opensearch.test.OpenSearchIntegTestCase'
                    baseClass 'com.colasoft.opensearch.test.rest.OpenSearchRestTestCase'
                    baseClass 'com.colasoft.opensearch.test.OpenSearchSingleNodeTestCase'
                }
            }
        }
    ...
    private static void configureDependencies(Project project) {
        project.dependencies {
            if (BuildParams.internal) {
                ...
                compileOnly "com.colasoft.opensearch:opensearch:${project.versions.opensearch}"
                testImplementation "com.colasoft.opensearch.test:framework:${project.versions.opensearch}"
            }
