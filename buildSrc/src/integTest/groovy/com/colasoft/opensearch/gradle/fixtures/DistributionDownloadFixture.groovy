...
package com.colasoft.opensearch.gradle.fixtures
...
class DistributionDownloadFixture {
    ...
    private static byte[] filebytes(String urlPath) throws IOException {
        ...
        return DistributionDownloadFixture.getResourceAsStream("/com/colasoft/opensearch/gradle/fake_opensearch." + suffix).getBytes()
    }
}
