...
package com.colasoft.opensearch.gradle.precommit;

import com.colasoft.opensearch.gradle.test.GradleIntegrationTestCase;
...
public class TestingConventionsTasksIT extends GradleIntegrationTestCase {
    ...
    public void testInnerClasses() {
        ...
        assertOutputContains(
            ...
            "  * com.colasoft.opensearch.gradle.testkit.NastyInnerClasses$LooksLikeATestWithoutNamingConvention1",
            "  * com.colasoft.opensearch.gradle.testkit.NastyInnerClasses$LooksLikeATestWithoutNamingConvention2",
            "  * com.colasoft.opensearch.gradle.testkit.NastyInnerClasses$LooksLikeATestWithoutNamingConvention3",
            "  * com.colasoft.opensearch.gradle.testkit.NastyInnerClasses$NamingConventionIT",
            "  * com.colasoft.opensearch.gradle.testkit.NastyInnerClasses$NamingConventionTests"
        );
    }
    ...
    public void testNamingConvention() {
        ...
        assertOutputContains(
            ...
            "  * com.colasoft.opensearch.gradle.testkit.LooksLikeATestWithoutNamingConvention1",
            "  * com.colasoft.opensearch.gradle.testkit.LooksLikeATestWithoutNamingConvention2",
            "  * com.colasoft.opensearch.gradle.testkit.LooksLikeATestWithoutNamingConvention3"
        );
    ...
    public void testAllTestTasksIncluded() {
        ...
        assertOutputContains(
            ...
            "  * com.colasoft.opensearch.gradle.testkit.NamingConventionIT"
        );
    }
    ...
    public void testTaskNotImplementBaseClass() {
        ...
        assertOutputContains(
            result.getOutput(),
            "Tests classes with suffix `IT` should extend com.colasoft.opensearch.gradle.testkit.Integration but the following classes do not:",
            "  * com.colasoft.opensearch.gradle.testkit.NamingConventionIT",
            "  * com.colasoft.opensearch.gradle.testkit.NamingConventionMissmatchIT",
            "Tests classes with suffix `Tests` should extend com.colasoft.opensearch.gradle.testkit.Unit but the following classes do not:",
            "  * com.colasoft.opensearch.gradle.testkit.NamingConventionMissmatchTests",
            "  * com.colasoft.opensearch.gradle.testkit.NamingConventionTests"
        );
    }
