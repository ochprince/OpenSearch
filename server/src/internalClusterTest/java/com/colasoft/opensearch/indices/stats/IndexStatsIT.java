...
package com.colasoft.opensearch.indices.stats;
...
public class IndexStatsIT extends OpenSearchIntegTestCase {
     ...
     * ({@link com.colasoft.opensearch.common.io.stream.StreamOutput#writeVLong(long)}), the stream would become corrupted. Here, we want to test
