...
package com.colasoft.opensearch.search.suggest;
...
import com.colasoft.opensearch.search.suggest.completion.FuzzyOptions;
import com.colasoft.opensearch.search.suggest.completion.context.CategoryContextMapping;
import com.colasoft.opensearch.search.suggest.completion.context.ContextMapping;
import com.colasoft.opensearch.search.suggest.completion.context.GeoContextMapping;
...
import static com.colasoft.opensearch.common.util.CollectionUtils.iterableAsArrayList;
...
public class CompletionSuggestSearchIT extends OpenSearchIntegTestCase {
    ...
    public void testThatFuzzySuggesterIsUnicodeAware() throws Exception {
        ...
        com.colasoft.opensearch.search.suggest.completion.CompletionSuggestionBuilder completionSuggestionBuilder = SuggestBuilders
