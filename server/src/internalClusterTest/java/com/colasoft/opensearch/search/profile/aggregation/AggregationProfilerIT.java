...
package com.colasoft.opensearch.search.profile.aggregation;
...
import com.colasoft.opensearch.search.aggregations.bucket.sampler.DiversifiedOrdinalsSamplerAggregator;
import com.colasoft.opensearch.search.aggregations.bucket.terms.GlobalOrdinalsStringTermsAggregator;
...
import static com.colasoft.opensearch.search.aggregations.AggregationBuilders.diversifiedSampler;
import static com.colasoft.opensearch.search.aggregations.AggregationBuilders.histogram;
import static com.colasoft.opensearch.search.aggregations.AggregationBuilders.max;
...
public class AggregationProfilerIT extends OpenSearchIntegTestCase {
    ...
    private static final Set<String> BREAKDOWN_KEYS = com.colasoft.opensearch.common.collect.Set.of(
        INITIALIZE,
    ...
    protected void setupSuiteScopeCluster() throws Exception {
        assertAcked(
            client().admin()
                .indices()
                .prepareCreate("idx")
                .setSettings(com.colasoft.opensearch.common.collect.Map.of("number_of_shards", 1, "number_of_replicas", 0))
    ...
    public void testSimpleProfile() {
        ...
        for (ProfileShardResult profileShardResult : profileResults.values()) {
            ...
            assertThat(debug.keySet(), equalTo(com.colasoft.opensearch.common.collect.Set.of(TOTAL_BUCKETS)));
    ...
    public void testMultiLevelProfile() {
        ...
        for (ProfileShardResult profileShardResult : profileResults.values()) {
            ...
            assertThat(histoDebugInfo.keySet(), equalTo(com.colasoft.opensearch.common.collect.Set.of(TOTAL_BUCKETS)));
            ...
            assertThat(avgAggResult.getDebugInfo(), equalTo(com.colasoft.opensearch.common.collect.Map.of()));
    ...
    public void testDiversifiedAggProfile() {
        ...
        for (ProfileShardResult profileShardResult : profileResults.values()) {
            ...
            assertThat(
                ...
                equalTo(com.colasoft.opensearch.common.collect.Map.of(DEFERRED, com.colasoft.opensearch.common.collect.List.of("max")))
            );
            ...
            assertThat(maxAggResult.getDebugInfo(), equalTo(com.colasoft.opensearch.common.collect.Map.of()));
