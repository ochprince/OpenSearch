...
import com.colasoft.opensearch.ingest.IngestTestPlugin;
...
public class BulkIntegrationIT extends OpenSearchIntegTestCase {
    ...
    public void testBulkIndexCreatesMapping() throws Exception {
        String bulkAction = copyToStringFromClasspath("/com/colasoft/opensearch/action/bulk/bulk-log.json");
    ...
    public void testBulkWithGlobalDefaults() throws Exception {
        ...
        String bulkAction = copyToStringFromClasspath("/com/colasoft/opensearch/action/bulk/simple-bulk-missing-index-type.json");
        {
            BulkRequestBuilder bulkBuilder = client().prepareBulk();
            bulkBuilder.add(bulkAction.getBytes(StandardCharsets.UTF_8), 0, bulkAction.length(), null, XContentType.JSON);
