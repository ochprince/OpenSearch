...
import com.colasoft.opensearch.cluster.RestoreInProgress.ShardRestoreStatus;
...
import com.colasoft.opensearch.cluster.metadata.DataStreamMetadata;
...
import com.colasoft.opensearch.cluster.routing.RecoverySource.RemoteStoreRecoverySource;
import com.colasoft.opensearch.cluster.routing.RoutingChangesObserver;
...
import static com.colasoft.opensearch.cluster.metadata.IndexMetadata.SETTING_HISTORY_UUID;
...
import static com.colasoft.opensearch.cluster.metadata.IndexMetadata.SETTING_VERSION_UPGRADED;
import static com.colasoft.opensearch.cluster.metadata.IndexMetadata.SETTING_REMOTE_STORE_ENABLED;
import static com.colasoft.opensearch.common.util.FeatureFlags.SEARCHABLE_SNAPSHOT_EXTENDED_COMPATIBILITY;
import static com.colasoft.opensearch.common.util.set.Sets.newHashSet;
import static com.colasoft.opensearch.index.store.remote.directory.RemoteSnapshotDirectory.SEARCHABLE_SNAPSHOT_EXTENDED_COMPATIBILITY_MINIMUM_VERSION;
import static com.colasoft.opensearch.snapshots.SnapshotUtils.filterIndices;
 ...
 * <p>
 * First {@link #restoreSnapshot(RestoreSnapshotRequest, com.colasoft.opensearch.action.ActionListener)}
...
public class RestoreService implements ClusterStateApplier {
    ...
    private static boolean isSearchableSnapshotsExtendedCompatibilityEnabled() {
        return com.colasoft.opensearch.Version.CURRENT.after(com.colasoft.opensearch.Version.V_2_4_0)
