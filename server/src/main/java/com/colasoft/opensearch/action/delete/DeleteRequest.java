 ...
 * {@link com.colasoft.opensearch.client.Requests#deleteRequest(String)}.
 * <p>
 * The operation requires the {@link #index()}, and {@link #id(String)} to
 * be set.
 *
 * @see DeleteResponse
 * @see com.colasoft.opensearch.client.Client#delete(DeleteRequest)
 * @see com.colasoft.opensearch.client.Requests#deleteRequest(String)
 *
 * @opensearch.internal
 */
