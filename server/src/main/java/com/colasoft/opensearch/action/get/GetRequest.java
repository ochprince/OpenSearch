...
package com.colasoft.opensearch.action.get;
...
import com.colasoft.opensearch.action.RealtimeRequest;
import com.colasoft.opensearch.action.ValidateActions;
import com.colasoft.opensearch.action.support.single.shard.SingleShardRequest;
 ...
 * {@link com.colasoft.opensearch.client.Requests#getRequest(String)}.
 * <p>
 * The operation requires the {@link #index()}} and {@link #id(String)}
 * to be set.
 *
 * @see GetResponse
 * @see com.colasoft.opensearch.client.Requests#getRequest(String)
 * @see com.colasoft.opensearch.client.Client#get(GetRequest)
 *
 * @opensearch.internal
 */
