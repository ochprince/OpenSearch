...
interface SearchPhaseContext extends Executor {
    ...
    /**
     * Returns a connection to the node if connected otherwise and {@link com.colasoft.opensearch.transport.ConnectTransportException} will be
     * thrown.
     */
     ...
     * @see com.colasoft.opensearch.search.query.QuerySearchResult#getContextId()
     * @see com.colasoft.opensearch.search.fetch.FetchSearchResult#getContextId()
     *
     */
