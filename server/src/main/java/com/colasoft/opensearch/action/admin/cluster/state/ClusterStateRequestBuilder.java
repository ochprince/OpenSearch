...
package com.colasoft.opensearch.action.admin.cluster.state;
...
public class ClusterStateRequestBuilder extends ClusterManagerNodeReadOperationRequestBuilder<
    ...
    /**
     * Should the cluster state result include the {@link com.colasoft.opensearch.cluster.metadata.Metadata}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link com.colasoft.opensearch.cluster.node.DiscoveryNodes}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link com.colasoft.opensearch.cluster.ClusterState.Custom}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link com.colasoft.opensearch.cluster.routing.RoutingTable}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * When {@link #setMetadata(boolean)} is set, which indices to return the {@link com.colasoft.opensearch.cluster.metadata.IndexMetadata}
