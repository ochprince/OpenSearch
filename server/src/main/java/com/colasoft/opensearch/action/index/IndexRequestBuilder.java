...
import com.colasoft.opensearch.action.support.WriteRequestBuilder;
import com.colasoft.opensearch.action.support.replication.ReplicationRequestBuilder;
...
public class IndexRequestBuilder extends ReplicationRequestBuilder<IndexRequest, IndexResponse, IndexRequestBuilder>
     ...
     * <p>
     * Note, its preferable to either set it using {@link #setSource(com.colasoft.opensearch.common.xcontent.XContentBuilder)}
    ...
    /**
     * Set to {@code true} to force this index to use {@link com.colasoft.opensearch.action.index.IndexRequest.OpType#CREATE}.
     */
