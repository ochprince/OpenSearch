...
package com.colasoft.opensearch.action.admin.indices.validate.query;
...
import com.colasoft.opensearch.action.support.broadcast.TransportBroadcastAction;
...
public class TransportValidateQueryAction extends TransportBroadcastAction<
    ...
    protected void doExecute(Task task, ValidateQueryRequest request, ActionListener<ValidateQueryResponse> listener) {
        ...
        ActionListener<com.colasoft.opensearch.index.query.QueryBuilder> rewriteListener = ActionListener.wrap(rewrittenQuery -> {
