...
public class BulkProcessor implements Closeable {
    ...
    public static class Builder {
         ...
         *
         * @see com.colasoft.opensearch.action.bulk.BackoffPolicy#exponentialBackoff()
         */
     ...
     * @param listener The BulkProcessor listener that gets called on bulk events
     * @return the builder for BulkProcessor
     * @deprecated Use {@link #builder(java.util.function.BiConsumer, com.colasoft.opensearch.action.bulk.BulkProcessor.Listener)}
     * with client::bulk as the first argument, or {@link #builder(com.colasoft.opensearch.client.Client,
     * com.colasoft.opensearch.action.bulk.BulkProcessor.Listener, com.colasoft.opensearch.threadpool.Scheduler,
     * com.colasoft.opensearch.threadpool.Scheduler, java.lang.Runnable)} and manage the flush and retry schedulers explicitly
     */
    @Deprecated
