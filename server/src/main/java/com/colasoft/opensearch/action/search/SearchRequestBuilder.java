...
public class SearchRequestBuilder extends ActionRequestBuilder<SearchRequest, SearchResponse> {
    ...
    /**
     * Should each {@link com.colasoft.opensearch.search.SearchHit} be returned with an
    ...
    /**
     * Should each {@link com.colasoft.opensearch.search.SearchHit} be returned with its
     * version.
     */
     ...
     *
     * @see com.colasoft.opensearch.search.sort.SortBuilders
     */
     ...
     * {@link #addRescorer(com.colasoft.opensearch.search.rescore.RescorerBuilder, int)}.
     *
