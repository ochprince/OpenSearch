 ...
 * Action requests implementing this can be part of {@link com.colasoft.opensearch.action.bulk.BulkRequest}
 *
 * @opensearch.internal
 */
public interface DocWriteRequest<T> extends IndicesRequest, Accountable {
     ...
     *
     * @param shardId shard id of the request. {@code null} when reading as part of a {@link com.colasoft.opensearch.action.bulk.BulkRequest}
     *                that does not have a unique shard id or when reading from a stream of version older than
     *                {@link com.colasoft.opensearch.action.bulk.BulkShardRequest#COMPACT_SHARD_ID_VERSION}
     */
