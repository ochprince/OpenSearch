...
package com.colasoft.opensearch.action.index;
...
import com.colasoft.opensearch.action.CompositeIndicesRequest;
 ...
 * created using {@link com.colasoft.opensearch.client.Requests#indexRequest(String)}.
 *
 ...
 * its string form ({@link #source(String, XContentType)}) or using a {@link com.colasoft.opensearch.common.xcontent.XContentBuilder}
 * ({@link #source(com.colasoft.opensearch.common.xcontent.XContentBuilder)}).
 *
 * If the {@link #id(String)} is not set, it will be automatically generated.
 *
 * @see IndexResponse
 * @see com.colasoft.opensearch.client.Requests#indexRequest(String)
 * @see com.colasoft.opensearch.client.Client#index(IndexRequest)
 *
 * @opensearch.internal
 */
public class IndexRequest extends ReplicatedWriteRequest<IndexRequest> implements DocWriteRequest<IndexRequest>, CompositeIndicesRequest {
     ...
     *
     * Note, its preferable to either set it using {@link #source(com.colasoft.opensearch.common.xcontent.XContentBuilder)}
     ...
     * {@link com.colasoft.opensearch.index.engine.VersionConflictEngineException} will be thrown.
     */
