...
/**
 * A request to create an index. Best created with {@link com.colasoft.opensearch.client.Requests#createIndexRequest(String)}.
 * <p>
 * The index created can optionally be created with {@link #settings(com.colasoft.opensearch.common.settings.Settings)}.
 *
