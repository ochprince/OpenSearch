...
import com.colasoft.opensearch.cluster.metadata.AliasAction;
...
import static com.colasoft.opensearch.cluster.metadata.IndexAbstraction.Type.ALIAS;
import static com.colasoft.opensearch.cluster.metadata.IndexAbstraction.Type.DATA_STREAM;
import static com.colasoft.opensearch.cluster.metadata.MetadataCreateDataStreamService.lookupTemplateForDataStream;
import static com.colasoft.opensearch.cluster.metadata.MetadataIndexTemplateService.findV1Templates;
import static com.colasoft.opensearch.cluster.metadata.MetadataIndexTemplateService.findV2Template;
...
public class MetadataRolloverService {
    ...
    private static final List<IndexAbstraction.Type> VALID_ROLLOVER_TARGETS = com.colasoft.opensearch.common.collect.List.of(ALIAS, DATA_STREAM);
