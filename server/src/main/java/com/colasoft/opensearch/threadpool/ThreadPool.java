...
import com.colasoft.opensearch.common.unit.SizeValue;
...
import com.colasoft.opensearch.common.util.concurrent.XRejectedExecutionHandler;
...
public class ThreadPool implements ReportingService<ThreadPoolInfo>, Scheduler {
     ...
     * @throws com.colasoft.opensearch.common.util.concurrent.OpenSearchRejectedExecutionException if the task cannot be scheduled for execution
     */
    @Override
