...
package com.colasoft.opensearch.index.translog.listener;

/**
 * The listener that gets fired on events related to {@link com.colasoft.opensearch.index.translog.TranslogManager}
 *
 * @opensearch.internal
 */
