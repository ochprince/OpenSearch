...
import com.colasoft.opensearch.indices.analysis.PreBuiltCacheFactory;
...
public final class PreConfiguredTokenizer extends PreConfiguredAnalysisComponent<TokenizerFactory> {
     ...
     * @param create builds the tokenizer
     */
    public static PreConfiguredTokenizer openSearchVersion(String name, Function<com.colasoft.opensearch.Version, Tokenizer> create) {
