...
public class NamedAnalyzer extends DelegatingAnalyzerWrapper {
    ...
    public NamedAnalyzer(String name, AnalyzerScope scope, Analyzer analyzer, int positionIncrementGap) {
        ...
        if (analyzer instanceof com.colasoft.opensearch.index.analysis.AnalyzerComponentsProvider) {
            this.analysisMode = ((com.colasoft.opensearch.index.analysis.AnalyzerComponentsProvider) analyzer).getComponents().analysisMode();
        } else {
