...
public final class RetentionLeaseStats implements ToXContentFragment, Writeable {
    ...
    /**
     * Converts the retention lease stats to {@link com.colasoft.opensearch.common.xcontent.XContent} using the specified builder and pararms.
     *
     * @param builder the builder
     * @param params  the params
     * @return the builder that this retention lease collection was converted to {@link com.colasoft.opensearch.common.xcontent.XContent} into
