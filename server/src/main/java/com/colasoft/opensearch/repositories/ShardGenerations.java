...
public final class ShardGenerations {
     ...
     * {@link com.colasoft.opensearch.index.snapshots.blobstore.BlobStoreIndexShardSnapshots} blob for it.
     */
    ...
    /**
     * Get the generation of the {@link com.colasoft.opensearch.index.snapshots.blobstore.BlobStoreIndexShardSnapshots} blob for a given index
     * and shard.
     ...
     *     {@link com.colasoft.opensearch.snapshots.SnapshotsService#SHARD_GEN_IN_REPO_DATA_VERSION}. If a caller expects a shard to exist in the
     ...
     * @return generation of the {@link com.colasoft.opensearch.index.snapshots.blobstore.BlobStoreIndexShardSnapshots} blob
     */
    @Nullable
