...
public interface Repository extends LifecycleComponent {
     ...
     * See {@link com.colasoft.opensearch.plugins.RepositoryPlugin}.
     */
    interface Factory {
        /**
     ...
     *             {@link com.colasoft.opensearch.snapshots.SnapshotsService#NO_REPO_INITIALIZE_VERSION} is present.
     */
    @Deprecated
     ...
     * @param verificationToken value returned by {@link com.colasoft.opensearch.repositories.Repository#startVerification()}
     ...
     * <p>
     * The index commit point can be obtained by using {@link com.colasoft.opensearch.index.engine.Engine#acquireLastIndexCommit} method.
     ...
     * thus the same semantics as with {@link com.colasoft.opensearch.cluster.ClusterStateApplier#applyClusterState} apply for the
