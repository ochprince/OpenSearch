...
import com.colasoft.opensearch.action.admin.indices.template.post.SimulateIndexTemplateRequest;
...
public class RestSimulateIndexTemplateAction extends BaseRestHandler {
    ...
    public List<Route> routes() {
        return com.colasoft.opensearch.common.collect.List.of(new Route(POST, "/_index_template/_simulate_index/{name}"));
    }
