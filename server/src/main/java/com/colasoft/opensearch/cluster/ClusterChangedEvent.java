...
import com.colasoft.opensearch.cluster.metadata.IndexGraveyard.IndexGraveyardDiff;
...
public class ClusterChangedEvent {
    ...
    /**
     * Returns the {@link com.colasoft.opensearch.cluster.node.DiscoveryNodes.Delta} between
