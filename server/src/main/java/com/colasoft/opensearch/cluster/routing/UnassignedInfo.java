...
public final class UnassignedInfo implements ToXContentFragment, Writeable {
    ...
    /**
     * A set of nodeIds that failed to complete allocations for this shard. {@link com.colasoft.opensearch.gateway.ReplicaShardAllocator}
     ...
     *
     * @see com.colasoft.opensearch.gateway.ReplicaShardAllocator#processExistingRecoveries(RoutingAllocation)
     * @see com.colasoft.opensearch.cluster.routing.allocation.AllocationService#applyFailedShards(ClusterState, List, List)
     */
