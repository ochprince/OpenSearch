...
public class ClusterService extends AbstractLifecycleComponent {
    ...
    public static final com.colasoft.opensearch.common.settings.Setting.AffixSetting<String> USER_DEFINED_METADATA = Setting.prefixKeySetting(
        "cluster.metadata.",
     ...
     * present in the createComponents signature of Plugin interface currently. {@link com.colasoft.opensearch.plugins.Plugin#createComponents}
