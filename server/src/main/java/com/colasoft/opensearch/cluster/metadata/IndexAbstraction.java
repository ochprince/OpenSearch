...
import static com.colasoft.opensearch.cluster.metadata.DataStream.getDefaultBackingIndexName;
import static com.colasoft.opensearch.cluster.metadata.IndexMetadata.INDEX_HIDDEN_SETTING;
import static com.colasoft.opensearch.common.collect.List.copyOf;
...
public interface IndexAbstraction {
    ...
    class DataStream implements IndexAbstraction {
        ...
        private final com.colasoft.opensearch.cluster.metadata.DataStream dataStream;
        private final List<IndexMetadata> dataStreamIndices;
        private final IndexMetadata writeIndex;

        public DataStream(com.colasoft.opensearch.cluster.metadata.DataStream dataStream, List<IndexMetadata> dataStreamIndices) {
            this.dataStream = dataStream;
        ...
        public com.colasoft.opensearch.cluster.metadata.DataStream getDataStream() {
            return dataStream;
        }
    }
}
