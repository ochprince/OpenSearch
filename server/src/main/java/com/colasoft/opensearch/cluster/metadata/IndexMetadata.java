...
import com.colasoft.opensearch.cluster.Diffable;
import com.colasoft.opensearch.cluster.DiffableUtils;
import com.colasoft.opensearch.cluster.block.ClusterBlock;
import com.colasoft.opensearch.cluster.block.ClusterBlockLevel;
import com.colasoft.opensearch.cluster.node.DiscoveryNodeFilters;
import com.colasoft.opensearch.cluster.routing.allocation.IndexMetadataUpdater;
import com.colasoft.opensearch.common.Nullable;
import com.colasoft.opensearch.common.collect.ImmutableOpenIntMap;
...
import static com.colasoft.opensearch.cluster.metadata.Metadata.CONTEXT_MODE_PARAM;
import static com.colasoft.opensearch.cluster.node.DiscoveryNodeFilters.IP_VALIDATOR;
import static com.colasoft.opensearch.cluster.node.DiscoveryNodeFilters.OpType.AND;
import static com.colasoft.opensearch.cluster.node.DiscoveryNodeFilters.OpType.OR;
import static com.colasoft.opensearch.common.settings.Settings.readSettingsFromStream;
import static com.colasoft.opensearch.common.settings.Settings.writeSettingsToStream;
...
public class IndexMetadata implements Diffable<IndexMetadata>, ToXContentFragment {
    ...
    public static class Builder {
        ...
        public static IndexMetadata fromXContent(XContentParser parser) throws IOException {
            ...
            // Reference:
            // https://github.com/opensearch-project/OpenSearch/blob/4dde0f2a3b445b2fc61dab29c5a2178967f4a3e3/server/src/main/java/com/colasoft/opensearch/cluster/metadata/IndexMetadata.java#L1620-L1628
     ...
     * {@link com.colasoft.opensearch.cluster.routing.OperationRouting#generateShardId(IndexMetadata, String, String)} to route documents
     ...
     * {@link com.colasoft.opensearch.cluster.routing.OperationRouting#generateShardId(IndexMetadata, String, String)} to guarantee consistent
