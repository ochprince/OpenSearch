...
public class AliasValidator {
    ...
    /**
     * Allows to validate an {@link com.colasoft.opensearch.cluster.metadata.AliasMetadata} and make sure
     * it's valid before it gets added to the index metadata. Doesn't validate the alias filter.
     * @throws IllegalArgumentException if the alias is not valid
     */
     ...
     * the alias filter via {@link com.colasoft.opensearch.common.xcontent.XContentParser},
     ...
     * provided {@link com.colasoft.opensearch.index.query.QueryShardContext}
