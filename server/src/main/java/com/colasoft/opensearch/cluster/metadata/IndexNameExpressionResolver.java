...
public class IndexNameExpressionResolver {
    ...
    private final List<ExpressionResolver> expressionResolvers = com.colasoft.opensearch.common.collect.List.of(
    ...
    public List<String> dataStreamNames(ClusterState state, IndicesOptions options, String... indexExpressions) {
        ...
        return ((dataStreams == null) ? com.colasoft.opensearch.common.collect.List.<String>of() : dataStreams).stream()
     ...
     * Callers should make sure they provide proper {@link com.colasoft.opensearch.action.support.IndicesOptions}
