 ...
 * simply returns an {@link com.colasoft.opensearch.action.ActionFuture}, while the second accepts an
 * {@link ActionListener}.
 * <p>
 * A client can be retrieved from a started {@link com.colasoft.opensearch.node.Node}.
 *
 * @see com.colasoft.opensearch.node.Node#client()
 *
 * @opensearch.internal
 */
