...
public class Requests {
     ...
     * @see com.colasoft.opensearch.client.Client#index(com.colasoft.opensearch.action.index.IndexRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.Client#delete(com.colasoft.opensearch.action.delete.DeleteRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.Client#get(com.colasoft.opensearch.action.get.GetRequest)
     */
     ...
     * actual JSON search source, or the {@link com.colasoft.opensearch.search.builder.SearchSourceBuilder}.
     *
     * @param indices The indices to search against. Use {@code null} or {@code _all} to execute against all indices
     * @return The search request
     * @see com.colasoft.opensearch.client.Client#search(com.colasoft.opensearch.action.search.SearchRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.Client#searchScroll(com.colasoft.opensearch.action.search.SearchScrollRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.IndicesAdminClient#shardStores(IndicesShardStoresRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.IndicesAdminClient#exists(IndicesExistsRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.IndicesAdminClient#create(CreateIndexRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.IndicesAdminClient#delete(DeleteIndexRequest)
     */
     ...
     * @return The delete index request
     * @see com.colasoft.opensearch.client.IndicesAdminClient#close(CloseIndexRequest)
     */
     ...
     * @return The delete index request
     * @see com.colasoft.opensearch.client.IndicesAdminClient#open(OpenIndexRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.IndicesAdminClient#putMapping(PutMappingRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.IndicesAdminClient#refresh(RefreshRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.IndicesAdminClient#flush(FlushRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.IndicesAdminClient#forceMerge(ForceMergeRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.IndicesAdminClient#upgrade(UpgradeRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.ClusterAdminClient#state(ClusterStateRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.ClusterAdminClient#health(ClusterHealthRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.ClusterAdminClient#nodesInfo(NodesInfoRequest)
     */
     ...
     * @return The nodes info request
     * @see com.colasoft.opensearch.client.ClusterAdminClient#nodesStats(NodesStatsRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.ClusterAdminClient#nodesUsage(NodesUsageRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.ClusterAdminClient#clusterStats(ClusterStatsRequest)
     */
     ...
     * @see com.colasoft.opensearch.client.ClusterAdminClient#listTasks(ListTasksRequest)
     */
     ...
     *
     * @return The nodes tasks request
     * @see com.colasoft.opensearch.client.ClusterAdminClient#getTask(GetTaskRequest)
     */
     ...
     *
     * @return The nodes tasks request
     * @see com.colasoft.opensearch.client.ClusterAdminClient#cancelTasks(CancelTasksRequest)
     */
