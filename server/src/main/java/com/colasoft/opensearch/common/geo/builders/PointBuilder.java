 ...
 * @opensearch.internal
 */
public class PointBuilder extends ShapeBuilder<Point, com.colasoft.opensearch.geometry.Point, PointBuilder> {
    ...
    @Override
    public com.colasoft.opensearch.geometry.Point buildGeometry() {
        return new com.colasoft.opensearch.geometry.Point(coordinates.get(0).x, coordinates.get(0).y);
    }
