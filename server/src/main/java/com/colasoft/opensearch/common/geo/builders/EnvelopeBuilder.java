 ...
 * @opensearch.internal
 */
public class EnvelopeBuilder extends ShapeBuilder<Rectangle, com.colasoft.opensearch.geometry.Rectangle, EnvelopeBuilder> {
    ...
    @Override
    public com.colasoft.opensearch.geometry.Rectangle buildGeometry() {
        return new com.colasoft.opensearch.geometry.Rectangle(topLeft.x, bottomRight.x, topLeft.y, bottomRight.y);
    }
