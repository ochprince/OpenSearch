...
package com.colasoft.opensearch.common.geo.builders;
 ...
 * @opensearch.internal
 */
public class PolygonBuilder extends ShapeBuilder<JtsGeometry, com.colasoft.opensearch.geometry.Geometry, PolygonBuilder> {
    ...
    @Override
    public com.colasoft.opensearch.geometry.Geometry buildGeometry() {
    ...
    public com.colasoft.opensearch.geometry.Polygon toPolygonGeometry() {
        final List<com.colasoft.opensearch.geometry.LinearRing> holes = new ArrayList<>(this.holes.size());
        for (int i = 0; i < this.holes.size(); ++i) {
            holes.add(linearRing(this.holes.get(i).coordinates));
        }
        return new com.colasoft.opensearch.geometry.Polygon(linearRing(this.shell.coordinates), holes);
    }

    protected static com.colasoft.opensearch.geometry.LinearRing linearRing(List<Coordinate> coordinates) {
        return new com.colasoft.opensearch.geometry.LinearRing(
