...
public class BytesStreamOutput extends BytesStream {
    ...
    /**
     * Returns the number of bytes used by the underlying {@link com.colasoft.opensearch.common.util.ByteArray}
     * @see com.colasoft.opensearch.common.util.ByteArray#ramBytesUsed()
     */
