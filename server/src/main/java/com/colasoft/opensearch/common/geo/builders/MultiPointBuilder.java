...
import com.colasoft.opensearch.common.geo.XShapeCollection;
...
public class MultiPointBuilder extends ShapeBuilder<XShapeCollection<Point>, MultiPoint, MultiPointBuilder> {
    ...
    public MultiPoint buildGeometry() {
        ...
        return new MultiPoint(
            coordinates.stream().map(coord -> new com.colasoft.opensearch.geometry.Point(coord.x, coord.y)).collect(Collectors.toList())
        );
    }
