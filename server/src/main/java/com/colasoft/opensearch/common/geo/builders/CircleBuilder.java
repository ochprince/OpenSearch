...
import com.colasoft.opensearch.common.unit.DistanceUnit.Distance;
 ...
 * @opensearch.internal
 */
public class CircleBuilder extends ShapeBuilder<Circle, com.colasoft.opensearch.geometry.Circle, CircleBuilder> {
     ...
     * @param radius radius of the circle (see {@link com.colasoft.opensearch.common.unit.DistanceUnit.Distance})
     * @return this
     */
    ...
    @Override
    public com.colasoft.opensearch.geometry.Circle buildGeometry() {
        return new com.colasoft.opensearch.geometry.Circle(center.x, center.y, unit.toMeters(radius));
    }
