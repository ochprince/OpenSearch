 ...
 * for deprecation logger. For instance <code>DeprecationLogger.getLogger("com.colasoft.opensearch.test.SomeClass")</code> will
 * result in a deprecation logger with name <code>com.colasoft.opensearch.deprecation.test.SomeClass</code>. This allows to use a
...
public class DeprecationLogger {
     ...
     * prefixes the logger name with "deprecation", if it starts with "com.colasoft.opensearch.",
     * it replaces "com.colasoft.opensearch" with "com.colasoft.opensearch.deprecation" to maintain
     * the "com.colasoft.opensearch" namespace.
     */
    ...
    private static Logger getDeprecatedLoggerForName(String name) {
        if (name.startsWith("com.colasoft.opensearch")) {
            name = name.replace("com.colasoft.opensearch.", "com.colasoft.opensearch.deprecation.");
        } else {
