...
public class SuggestBuilder implements Writeable, ToXContentObject {
     ...
     * to be set either via this setter or via the {@link com.colasoft.opensearch.search.suggest.SuggestionBuilder#text(String)} method.
     * <p>
    ...
    /**
     * Adds an {@link com.colasoft.opensearch.search.suggest.SuggestionBuilder} instance under a user defined name.
