...
import static com.colasoft.opensearch.search.aggregations.bucket.terms.MultiTermsAggregationBuilder.REGISTRY_KEY;
...
public class MultiTermsAggregationFactory extends AggregatorFactory {
    ...
    public static void registerAggregators(ValuesSourceRegistry.Builder builder) {
        builder.register(
            REGISTRY_KEY,
            com.colasoft.opensearch.common.collect.List.of(CoreValuesSourceType.BYTES, CoreValuesSourceType.IP),
            config -> {
        ...
        builder.register(
            REGISTRY_KEY,
            com.colasoft.opensearch.common.collect.List.of(CoreValuesSourceType.NUMERIC, CoreValuesSourceType.BOOLEAN, CoreValuesSourceType.DATE),
            config -> {
