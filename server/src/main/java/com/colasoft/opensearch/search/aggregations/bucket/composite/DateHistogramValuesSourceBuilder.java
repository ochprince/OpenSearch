...
import com.colasoft.opensearch.search.aggregations.bucket.histogram.DateIntervalConsumer;
import com.colasoft.opensearch.search.aggregations.bucket.histogram.DateIntervalWrapper;
...
public class DateHistogramValuesSourceBuilder extends CompositeValuesSourceBuilder<DateHistogramValuesSourceBuilder>
    ...
    public static void register(ValuesSourceRegistry.Builder builder) {
        builder.register(
            REGISTRY_KEY,
            com.colasoft.opensearch.common.collect.List.of(CoreValuesSourceType.DATE, CoreValuesSourceType.NUMERIC),
