...
import com.colasoft.opensearch.search.fetch.FetchContext;
import com.colasoft.opensearch.search.fetch.FetchSubPhase;
import com.colasoft.opensearch.search.fetch.FetchSubPhaseProcessor;
...
public final class FetchFieldsPhase implements FetchSubPhase {
    ...
    private Set<String> getIgnoredFields(SearchHit hit) {
        ...
        if (field == null) {
            return com.colasoft.opensearch.common.collect.Set.of();
        }
