...
import com.colasoft.opensearch.common.xcontent.ObjectParser.ValueType;
...
import com.colasoft.opensearch.search.lookup.SourceLookup;
...
import static com.colasoft.opensearch.common.lucene.Lucene.readExplanation;
import static com.colasoft.opensearch.common.lucene.Lucene.writeExplanation;
import static com.colasoft.opensearch.common.xcontent.ConstructingObjectParser.constructorArg;
import static com.colasoft.opensearch.common.xcontent.ConstructingObjectParser.optionalConstructorArg;
...
public final class SearchHit implements Writeable, ToXContentObject, Iterable<DocumentField> {
    ...
    * */
     ...
     * {@link com.colasoft.opensearch.search.suggest.completion.CompletionSuggestion.Entry.Option} which unfortunately inlines
     * the output of
     * {@link #toInnerXContent(XContentBuilder, com.colasoft.opensearch.common.xcontent.ToXContent.Params)}
