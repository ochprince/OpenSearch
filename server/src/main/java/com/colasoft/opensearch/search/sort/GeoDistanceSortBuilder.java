...
import com.colasoft.opensearch.index.fielddata.plain.AbstractLatLonPointIndexFieldData.LatLonPointIndexFieldData;
import com.colasoft.opensearch.index.mapper.MappedFieldType;
import com.colasoft.opensearch.index.query.GeoValidationMethod;
...
public class GeoDistanceSortBuilder extends SortBuilder<GeoDistanceSortBuilder> {
    ...
    /**
     * The distance unit to use. Defaults to {@link com.colasoft.opensearch.common.unit.DistanceUnit#METERS}
     */
    ...
    /**
     * Returns the distance unit to use. Defaults to {@link com.colasoft.opensearch.common.unit.DistanceUnit#METERS}
     */
