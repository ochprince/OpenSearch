...
public interface ValuesSourceType {
     ...
     * {@link com.colasoft.opensearch.search.aggregations.AggregationExecutionException}.  Note that this method is called when a script is
     ...
     * {@link com.colasoft.opensearch.search.aggregations.AggregationExecutionException}
     *
     ...
     * {@link com.colasoft.opensearch.index.mapper.MappedFieldType}, it prefers to get the formatter from there.  Only when a field can't be
