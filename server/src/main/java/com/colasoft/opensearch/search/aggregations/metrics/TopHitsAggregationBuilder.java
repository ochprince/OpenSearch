...
import com.colasoft.opensearch.search.builder.SearchSourceBuilder.ScriptField;
...
public class TopHitsAggregationBuilder extends AbstractAggregationBuilder<TopHitsAggregationBuilder> {
    ...
    /**
     * Should each {@link com.colasoft.opensearch.search.SearchHit} be returned
    ...
    protected TopHitsAggregatorFactory doBuild(QueryShardContext queryShardContext, AggregatorFactory parent, Builder subfactoriesBuilder)
        ...
        if (this.scriptFields != null) {
            for (ScriptField field : this.scriptFields) {
                ...
                scriptFields.add(
                    new com.colasoft.opensearch.search.fetch.subphase.ScriptFieldsContext.ScriptField(
                        field.fieldName(),
                        searchScript,
                        field.ignoreFailure()
                    )
