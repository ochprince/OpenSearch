...
package com.colasoft.opensearch.search.builder;
...
import com.colasoft.opensearch.search.fetch.subphase.FieldAndFormat;
...
import static com.colasoft.opensearch.search.internal.SearchContext.TRACK_TOTAL_HITS_ACCURATE;
import static com.colasoft.opensearch.search.internal.SearchContext.TRACK_TOTAL_HITS_DISABLED;

/**
 * A search source builder allowing to easily build search source. Simple
 * construction using
 * {@link com.colasoft.opensearch.search.builder.SearchSourceBuilder#searchSource()}.
 *
 * @see com.colasoft.opensearch.action.search.SearchRequest#source(SearchSourceBuilder)
 *
 * @opensearch.internal
 */
public final class SearchSourceBuilder implements Writeable, ToXContentObject, Rewriteable<SearchSourceBuilder> {
     ...
     *
     * @see com.colasoft.opensearch.index.query.QueryBuilders
     */
    ...
    /**
     * Should each {@link com.colasoft.opensearch.search.SearchHit} be returned with
    ...
    /**
     * Should each {@link com.colasoft.opensearch.search.SearchHit} be returned with a
    ...
    /**
     * Should each {@link com.colasoft.opensearch.search.SearchHit} be returned with the
    ...
    /**
     * Indicates whether {@link com.colasoft.opensearch.search.SearchHit}s should be returned with the
     * sequence number and primary term of the last modification of the document.
     */
