...
package com.colasoft.opensearch.search.profile;
...
import com.colasoft.opensearch.common.xcontent.InstantiatingObjectParser;
...
public final class ProfileResult implements Writeable, ToXContentObject {
    ...
    public ProfileResult(
        ...
        this.debug = debug == null ? com.colasoft.opensearch.common.collect.Map.of() : debug;
        this.children = children == null ? com.colasoft.opensearch.common.collect.List.of() : children;
    ...
    public ProfileResult(StreamInput in) throws IOException {
        ...
        if (in.getVersion().onOrAfter(LegacyESVersion.V_7_9_0)) {
            ...
            debug = com.colasoft.opensearch.common.collect.Map.of();
        }
