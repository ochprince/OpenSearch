...
import com.colasoft.opensearch.common.Rounding.Prepared;
import com.colasoft.opensearch.common.lucene.ScorerAware;
import com.colasoft.opensearch.common.util.CollectionUtils;
import com.colasoft.opensearch.index.fielddata.AbstractSortingNumericDocValues;
import com.colasoft.opensearch.index.fielddata.DocValueBits;
import com.colasoft.opensearch.index.fielddata.IndexFieldData;
import com.colasoft.opensearch.index.fielddata.IndexGeoPointFieldData;
import com.colasoft.opensearch.index.fielddata.IndexNumericFieldData;
import com.colasoft.opensearch.index.fielddata.IndexOrdinalsFieldData;
import com.colasoft.opensearch.index.fielddata.LeafOrdinalsFieldData;
...
import com.colasoft.opensearch.index.fielddata.SortingBinaryDocValues;
import com.colasoft.opensearch.index.fielddata.SortingNumericDoubleValues;
import com.colasoft.opensearch.index.mapper.RangeType;
import com.colasoft.opensearch.script.AggregationScript;
import com.colasoft.opensearch.search.aggregations.AggregationExecutionException;
import com.colasoft.opensearch.search.aggregations.support.ValuesSource.Bytes.WithScript.BytesValues;
import com.colasoft.opensearch.search.aggregations.support.values.ScriptBytesValues;
import com.colasoft.opensearch.search.aggregations.support.values.ScriptDoubleValues;
import com.colasoft.opensearch.search.aggregations.support.values.ScriptLongValues;
...
public abstract class ValuesSource {
    ...
    public static class Range extends ValuesSource {
        ...
        public DocValueBits docsWithValue(LeafReaderContext context) throws IOException {
            ...
            return com.colasoft.opensearch.index.fielddata.FieldData.docsWithValue(bytes);
        }
        ...
        public abstract static class WithOrdinals extends Bytes {
            ...
            public static final WithOrdinals EMPTY = new WithOrdinals() {
                ...
                public SortedBinaryDocValues bytesValues(LeafReaderContext context) throws IOException {
                    return com.colasoft.opensearch.index.fielddata.FieldData.emptySortedBinary();
                }
            ...
            public DocValueBits docsWithValue(LeafReaderContext context) throws IOException {
                ...
                return com.colasoft.opensearch.index.fielddata.FieldData.docsWithValue(ordinals);
            }
    ...
    public abstract static class Numeric extends ValuesSource {
        ...
        public static final Numeric EMPTY = new Numeric() {
            ...
            public SortedNumericDoubleValues doubleValues(LeafReaderContext context) throws IOException {
                return com.colasoft.opensearch.index.fielddata.FieldData.emptySortedNumericDoubles();
            }
        ...
        public DocValueBits docsWithValue(LeafReaderContext context) throws IOException {
            if (isFloatingPoint()) {
                ...
                return com.colasoft.opensearch.index.fielddata.FieldData.docsWithValue(values);
            } else {
    ...
    public abstract static class GeoPoint extends ValuesSource {
        ...
        public static final GeoPoint EMPTY = new GeoPoint() {
            ...
            public MultiGeoPointValues geoPointValues(LeafReaderContext context) {
                return com.colasoft.opensearch.index.fielddata.FieldData.emptyMultiGeoPoints();
            }
        ...
        public DocValueBits docsWithValue(LeafReaderContext context) throws IOException {
            ...
            return com.colasoft.opensearch.index.fielddata.FieldData.docsWithValue(geoPoints);
        }
        ...
        public static class Fielddata extends GeoPoint {
            ...
            public com.colasoft.opensearch.index.fielddata.MultiGeoPointValues geoPointValues(LeafReaderContext context) {
