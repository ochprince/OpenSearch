...
package com.colasoft.opensearch.search.suggest.completion.context;
...
import com.colasoft.opensearch.search.suggest.completion.context.ContextMapping.Type;
...
import static com.colasoft.opensearch.search.suggest.completion.context.ContextMapping.FIELD_NAME;
import static com.colasoft.opensearch.search.suggest.completion.context.ContextMapping.FIELD_TYPE;
...
public class ContextMappings implements ToXContent, Iterable<ContextMapping<?>> {
     ...
     * see {@link com.colasoft.opensearch.search.suggest.completion.context.ContextMappings.TypedContextField}
     */
