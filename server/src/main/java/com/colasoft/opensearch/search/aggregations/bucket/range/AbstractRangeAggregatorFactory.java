...
import com.colasoft.opensearch.search.aggregations.bucket.range.RangeAggregator.Range;
import com.colasoft.opensearch.search.aggregations.bucket.range.RangeAggregator.Unmapped;
import com.colasoft.opensearch.search.aggregations.support.CoreValuesSourceType;
import com.colasoft.opensearch.search.aggregations.support.ValuesSource.Numeric;
...
public class AbstractRangeAggregatorFactory<R extends Range> extends ValuesSourceAggregatorFactory {
    ...
    public static void registerAggregators(
        ...
        builder.register(
            registryKey,
            com.colasoft.opensearch.common.collect.List.of(CoreValuesSourceType.NUMERIC, CoreValuesSourceType.DATE, CoreValuesSourceType.BOOLEAN),
            RangeAggregator::new,
            true
        );
    }
