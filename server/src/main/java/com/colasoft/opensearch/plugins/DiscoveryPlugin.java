...
public interface DiscoveryPlugin {
     ...
     * (see {@link com.colasoft.opensearch.discovery.DiscoveryModule#DISCOVERY_SEED_PROVIDERS_SETTING}), and
     * the value is a supplier to construct the host provider when it is selected for use.
     *
     * @param transportService Use to form the {@link com.colasoft.opensearch.common.transport.TransportAddress} portion
     *                         of a {@link com.colasoft.opensearch.cluster.node.DiscoveryNode}
