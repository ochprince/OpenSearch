...
import com.colasoft.opensearch.common.lucene.search.function.ScoreFunction;
...
import com.colasoft.opensearch.index.query.QueryParser;
...
import com.colasoft.opensearch.search.aggregations.bucket.composite.CompositeAggregationParsingFunction;
...
import com.colasoft.opensearch.search.sort.SortParser;
...
public interface SearchPlugin {
    ...
    class AggregationSpec extends SearchExtensionSpec<AggregationBuilder, ContextParser<String, ? extends AggregationBuilder>> {
        ...
        /**
         * Get the function to register the {@link com.colasoft.opensearch.search.aggregations.support.ValuesSource} to aggregator mappings for
         * this aggregation
         */
        ...
        /**
         * Set the function to register the {@link com.colasoft.opensearch.search.aggregations.support.ValuesSource} to aggregator mappings for
         * this aggregation
         */
    ...
    class CompositeAggregationSpec {
         ...
         * {@link com.colasoft.opensearch.search.aggregations.support.ValuesSource} to aggregator mappings for Composite
         *                            aggregation
