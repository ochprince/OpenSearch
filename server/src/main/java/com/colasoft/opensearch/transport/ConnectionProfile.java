 ...
 * ({@link com.colasoft.opensearch.transport.TransportRequestOptions.Type}). This allows to tailor a connection towards a specific usage.
 *
 * @opensearch.internal
 */
public final class ConnectionProfile {
    ...
    public static class Builder {
         ...
         * @throws IllegalStateException if any of the {@link com.colasoft.opensearch.transport.TransportRequestOptions.Type} enum is missing
         */
     ...
     * {@link com.colasoft.opensearch.transport.TransportRequestOptions.Type#BULK} shares connections with
     * {@link com.colasoft.opensearch.transport.TransportRequestOptions.Type#REG} they will return both the same number of connections from
