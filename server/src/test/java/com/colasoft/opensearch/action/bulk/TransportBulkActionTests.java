...
import com.colasoft.opensearch.action.bulk.TransportBulkActionTookTests.Resolver;
...
import com.colasoft.opensearch.cluster.metadata.IndexAbstraction.Index;
...
import static com.colasoft.opensearch.action.bulk.TransportBulkAction.prohibitCustomRoutingOnDataStream;
import static com.colasoft.opensearch.cluster.metadata.MetadataCreateDataStreamServiceTests.createDataStream;
...
public class TransportBulkActionTests extends OpenSearchTestCase {
    ...
    public void testIncludesSystem() {
        ...
        SystemIndices systemIndices = new SystemIndices(
            com.colasoft.opensearch.common.collect.Map.of("plugin", com.colasoft.opensearch.common.collect.List.of(new SystemIndexDescriptor(".test", "")))
        );
        List<String> onlySystem = com.colasoft.opensearch.common.collect.List.of(".foo", ".bar");
        assertTrue(bulkAction.includesSystem(buildBulkRequest(onlySystem), indicesLookup, systemIndices));

        onlySystem = com.colasoft.opensearch.common.collect.List.of(".foo", ".bar", ".test");
        assertTrue(bulkAction.includesSystem(buildBulkRequest(onlySystem), indicesLookup, systemIndices));

        List<String> nonSystem = com.colasoft.opensearch.common.collect.List.of("foo", "bar");
        assertFalse(bulkAction.includesSystem(buildBulkRequest(nonSystem), indicesLookup, systemIndices));

        List<String> mixed = com.colasoft.opensearch.common.collect.List.of(".foo", ".test", "other");
