...
import com.colasoft.opensearch.action.admin.indices.datastream.GetDataStreamAction.Request;
...
import static com.colasoft.opensearch.action.admin.indices.datastream.DeleteDataStreamRequestTests.getClusterStateWithDataStreams;
...
public class GetDataStreamsRequestTests extends AbstractWireSerializingTestCase<Request> {
    ...
    public void testGetDataStream() {
        ...
        ClusterState cs = getClusterStateWithDataStreams(
            com.colasoft.opensearch.common.collect.List.of(new Tuple<>(dataStreamName, 1)),
    ...
    public void testGetDataStreamsWithWildcards() {
        ...
        ClusterState cs = getClusterStateWithDataStreams(
            com.colasoft.opensearch.common.collect.List.of(new Tuple<>(dataStreamNames[0], 1), new Tuple<>(dataStreamNames[1], 1)),
            com.colasoft.opensearch.common.collect.List.of()
        );
