...
import com.colasoft.opensearch.action.termvectors.TermVectorsRequest.Flag;
...
public class TermVectorsUnitTests extends OpenSearchTestCase {
    ...
    public void testMultiParser() throws Exception {
        byte[] bytes = StreamsUtils.copyToBytesFromClasspath("/com/colasoft/opensearch/action/termvectors/multiRequest1.json");
        ...
        bytes = StreamsUtils.copyToBytesFromClasspath("/com/colasoft/opensearch/action/termvectors/multiRequest2.json");
    ...
    public void testMultiParserFilter() throws Exception {
        byte[] bytes = StreamsUtils.copyToBytesFromClasspath("/com/colasoft/opensearch/action/termvectors/multiRequest3.json");
        XContentParser data = createParser(JsonXContent.jsonXContent, bytes);
        MultiTermVectorsRequest request = new MultiTermVectorsRequest();
        request.add(new TermVectorsRequest(), data);
