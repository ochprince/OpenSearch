...
import com.colasoft.opensearch.action.admin.indices.datastream.DeleteDataStreamRequestTests;
...
import static com.colasoft.opensearch.common.collect.Tuple.tuple;
...
public class PutMappingRequestTests extends OpenSearchTestCase {
    ...
    public void testResolveIndicesWithWriteIndexOnlyAndDataStreamsAndWriteAliases() {
        ...
        List<Tuple<String, Integer>> dsMetadata = com.colasoft.opensearch.common.collect.List.of(
        ...
        ClusterState cs = DeleteDataStreamRequestTests.getClusterStateWithDataStreams(
            dsMetadata,
            com.colasoft.opensearch.common.collect.List.of("index1", "index2", "index3")
        );
        cs = addAliases(
            cs,
            com.colasoft.opensearch.common.collect.List.of(
                tuple("alias1", com.colasoft.opensearch.common.collect.List.of(tuple("index1", false), tuple("index2", true))),
                tuple("alias2", com.colasoft.opensearch.common.collect.List.of(tuple("index2", false), tuple("index3", true)))
            )
        );
    ...
    public void testResolveIndicesWithoutWriteIndexOnlyAndDataStreamsAndWriteAliases() {
        ...
        expectedIndices.addAll(com.colasoft.opensearch.common.collect.List.of("index1", "index2", "index3"));
    ...
    public void testResolveIndicesWithWriteIndexOnlyAndAliasWithoutWriteIndex() {
        ...
        final ClusterState cs2 = addAliases(
            cs,
            com.colasoft.opensearch.common.collect.List.of(
                tuple("alias1", com.colasoft.opensearch.common.collect.List.of(tuple("index1", false), tuple("index2", false))),
                tuple("alias2", com.colasoft.opensearch.common.collect.List.of(tuple("index2", false), tuple("index3", false)))
            )
        );
