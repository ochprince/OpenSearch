...
import com.colasoft.opensearch.action.OriginalIndicesTests;
import com.colasoft.opensearch.action.admin.cluster.shards.ClusterSearchShardsGroup;
...
import com.colasoft.opensearch.cluster.routing.GroupShardsIteratorTests;
...
import com.colasoft.opensearch.transport.NodeDisconnectedException;
import com.colasoft.opensearch.transport.RemoteClusterConnectionTests;
import com.colasoft.opensearch.transport.RemoteClusterService;
import com.colasoft.opensearch.transport.RemoteClusterServiceTests;
import com.colasoft.opensearch.transport.RemoteTransportException;
import com.colasoft.opensearch.transport.Transport;
import com.colasoft.opensearch.transport.TransportConnectionListener;
...
import static com.colasoft.opensearch.test.InternalAggregationTestCase.emptyReduceContextBuilder;
import static com.colasoft.opensearch.test.hamcrest.OpenSearchAssertions.awaitLatch;
...
public class TransportSearchActionTests extends OpenSearchTestCase {
    ...
    public void testShouldPreFilterSearchShards() {
        ...
        ClusterState clusterState = ClusterState.builder(ClusterName.DEFAULT).build();
        {
            ...
            assertFalse(
                TransportSearchAction.shouldPreFilterSearchShards(clusterState, searchRequest, indices, randomIntBetween(129, 10000))
            );
        }
        {
    ...
    public void testShouldPreFilterSearchShardsWithReadOnly() {
        ...
        {
            SearchRequest searchRequest = new SearchRequest();
            assertFalse(TransportSearchAction.shouldPreFilterSearchShards(clusterState, searchRequest, indices, randomIntBetween(2, 127)));
            assertFalse(
                TransportSearchAction.shouldPreFilterSearchShards(clusterState, searchRequest, indices, randomIntBetween(127, 10000))
            );
        }
