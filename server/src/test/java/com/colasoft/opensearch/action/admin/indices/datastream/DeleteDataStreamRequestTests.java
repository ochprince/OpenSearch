...
import com.colasoft.opensearch.action.admin.indices.datastream.DeleteDataStreamAction.Request;
...
public class DeleteDataStreamRequestTests extends AbstractWireSerializingTestCase<Request> {
    ...
    public void testDeleteDataStream() {
        ...
        final List<String> otherIndices = randomSubsetOf(com.colasoft.opensearch.common.collect.List.of("foo", "bar", "baz"));
        ClusterState cs = getClusterStateWithDataStreams(
            com.colasoft.opensearch.common.collect.List.of(new Tuple<>(dataStreamName, 2)),
            otherIndices
        );
