...
public class AutoCreateIndexTests extends OpenSearchTestCase {
    ...
    public void testUpdate() {
        ...
        AutoCreateIndex autoCreateIndex = new AutoCreateIndex(
            ...
            new SystemIndices(com.colasoft.opensearch.common.collect.Map.of())
        );
    ...
    private static ClusterState buildClusterState(String... indices) {
        ...
        return ClusterState.builder(com.colasoft.opensearch.cluster.ClusterName.CLUSTER_NAME_SETTING.getDefault(Settings.EMPTY))
            .metadata(metadata)
            .build();
    }
    ...
    private AutoCreateIndex newAutoCreateIndex(Settings settings) {
        SystemIndices systemIndices = new SystemIndices(
            com.colasoft.opensearch.common.collect.Map.of(
                "plugin",
                com.colasoft.opensearch.common.collect.List.of(new SystemIndexDescriptor(TEST_SYSTEM_INDEX_NAME, ""))
            )
        );
