...
package com.colasoft.opensearch.action.admin.indices.resolve;

import com.colasoft.opensearch.action.admin.indices.resolve.ResolveIndexAction.ResolvedAlias;
import com.colasoft.opensearch.action.admin.indices.resolve.ResolveIndexAction.ResolvedDataStream;
import com.colasoft.opensearch.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex;
import com.colasoft.opensearch.action.admin.indices.resolve.ResolveIndexAction.Response;
import com.colasoft.opensearch.common.Strings;
import com.colasoft.opensearch.common.io.stream.Writeable;
import com.colasoft.opensearch.common.xcontent.ConstructingObjectParser;
...
import static com.colasoft.opensearch.action.admin.indices.resolve.ResolveIndexAction.ResolvedDataStream.BACKING_INDICES_FIELD;
import static com.colasoft.opensearch.action.admin.indices.resolve.ResolveIndexAction.ResolvedDataStream.TIMESTAMP_FIELD;
import static com.colasoft.opensearch.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex.ALIASES_FIELD;
import static com.colasoft.opensearch.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex.ATTRIBUTES_FIELD;
import static com.colasoft.opensearch.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex.DATA_STREAM_FIELD;
import static com.colasoft.opensearch.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndexAbstraction.NAME_FIELD;
import static com.colasoft.opensearch.action.admin.indices.resolve.ResolveIndexAction.Response.DATA_STREAMS_FIELD;
import static com.colasoft.opensearch.action.admin.indices.resolve.ResolveIndexAction.Response.INDICES_FIELD;
...
public class ResolveIndexResponseTests extends AbstractSerializingTestCase<Response> {
    ...
    private static ResolvedIndex createTestResolvedIndexInstance() {
        ...
        String[] attributes = randomSubsetOf(com.colasoft.opensearch.common.collect.List.of("open", "hidden", "frozen")).toArray(
            Strings.EMPTY_ARRAY
        );
