...
import static com.colasoft.opensearch.common.settings.AbstractScopedSettings.ARCHIVED_SETTINGS_PREFIX;
...
public class SettingsUpdaterTests extends OpenSearchTestCase {
    ...
    public void testDeprecationLogging() {
        ...
        final Settings toApplyDebug = Settings.builder().put("logger.com.colasoft.opensearch", "debug").build();
        ...
        final Settings toApplyUnset = Settings.builder().putNull("logger.com.colasoft.opensearch").build();
    ...
    private static Setting<String> invalidInIsolationSetting(int index) {
        return Setting.simpleString("invalid.setting" + index, new Setting.Validator<String>() {
