...
import com.colasoft.opensearch.indices.cluster.ClusterStateChanges;
...
import com.colasoft.opensearch.transport.TestTransportChannel;
...
import static com.colasoft.opensearch.action.support.replication.ClusterStateCreationUtils.stateWithActivePrimary;
import static com.colasoft.opensearch.cluster.metadata.IndexMetadata.SETTING_WAIT_FOR_ACTIVE_SHARDS;
...
public class TransportReplicationActionTests extends OpenSearchTestCase {
    ...
    */
    ...
    public void testSeqNoIsSetOnPrimary() {
        ...
        // noinspection unchecked
        assertThat(
            ((TransportReplicationAction.ConcreteShardRequest<Request>) requestsToReplicas[0].request).getPrimaryTerm(),
            equalTo(primaryTerm)
        );
    }
    ...
    /**
     * test throwing a {@link com.colasoft.opensearch.action.support.replication.TransportReplicationAction.RetryOnReplicaException}
     * causes a retry
     */
