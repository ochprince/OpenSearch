...
import com.colasoft.opensearch.action.admin.indices.create.AutoCreateAction.TransportAction;
...
public class RegisterTransportActionsRequestTests extends OpenSearchTestCase {
    ...
    public void testToString() {
        assertEquals(
            ...
            "TransportActionsRequest{uniqueId=extension-uniqueId, actions={testAction=class com.colasoft.opensearch.action.admin.indices.create.AutoCreateAction$TransportAction}}"
        );
    }
}
