...
public class SettingsFilterTests extends OpenSearchTestCase {
    ...
    public void testFilteredSettingIsNotLogged() throws Exception {
        ...
        assertExpectedLogMessages(
            ...
            new MockLogAppender.SeenEventExpectation("secure logging", "com.colasoft.opensearch.test", Level.INFO, "updating [key]"),
            new MockLogAppender.UnseenEventExpectation("unwanted old setting name", "com.colasoft.opensearch.test", Level.INFO, "*old*"),
            new MockLogAppender.UnseenEventExpectation("unwanted new setting name", "com.colasoft.opensearch.test", Level.INFO, "*new*")
        );
    }
    ...
    private void assertExpectedLogMessages(Consumer<Logger> consumer, MockLogAppender.LoggingExpectation... expectations)
        ...
        Logger testLogger = LogManager.getLogger("com.colasoft.opensearch.test");
