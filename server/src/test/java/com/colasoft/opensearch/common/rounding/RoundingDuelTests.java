...
public class RoundingDuelTests extends OpenSearchTestCase {
    ...
    public void testDuellingImplementations() {
        com.colasoft.opensearch.common.Rounding.DateTimeUnit randomDateTimeUnit = randomFrom(com.colasoft.opensearch.common.Rounding.DateTimeUnit.values());
        com.colasoft.opensearch.common.Rounding.Prepared rounding;
        Rounding roundingJoda;

        if (randomBoolean()) {
            rounding = com.colasoft.opensearch.common.Rounding.builder(randomDateTimeUnit).timeZone(ZoneOffset.UTC).build().prepareForUnknown();
            ...
            rounding = com.colasoft.opensearch.common.Rounding.builder(interval).timeZone(ZoneOffset.UTC).build().prepareForUnknown();
