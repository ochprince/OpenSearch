...
public abstract class BaseXContentTestCase extends OpenSearchTestCase {
    ...
    public void testObjects() throws Exception {
        ...
        objects.put(
            "{'objects':['" + formatter.print(d1.getTime()) + "','" + formatter.print(d2.getTime()) + "']}",
            new Object[] { d1, d2 }
        );
    ...
    public void testUnknownObject() throws Exception {
        ...
        objects.put("{'obj':'class com.colasoft.opensearch.common.xcontent.BaseXContentTestCase'}", BaseXContentTestCase.class);
