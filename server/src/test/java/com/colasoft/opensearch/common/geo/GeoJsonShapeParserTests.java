...
import com.colasoft.opensearch.common.geo.parsers.ShapeParser;
...
import com.colasoft.opensearch.index.mapper.GeoShapeIndexer;
import com.colasoft.opensearch.index.mapper.LegacyGeoShapeFieldMapper;
import com.colasoft.opensearch.index.mapper.Mapper;
import com.colasoft.opensearch.test.VersionUtils;
import com.colasoft.opensearch.test.hamcrest.OpenSearchGeoAssertions;
...
import static com.colasoft.opensearch.common.geo.builders.ShapeBuilder.SPATIAL_CONTEXT;
...
public class GeoJsonShapeParserTests extends BaseGeoParsingTestCase {
    ...
    public void testParsePoint() throws IOException, ParseException {
        ...
        assertGeometryEquals(new com.colasoft.opensearch.geometry.Point(100d, 0d), pointGeoJson, false);
    }
    ...
    public void testParseEnvelope() throws IOException, ParseException {
        ...
        assertGeometryEquals(expected, multilinesGeoJson, true);
        assertGeometryEquals(new com.colasoft.opensearch.geometry.Rectangle(-50, 50, 30, -30), multilinesGeoJson, false);
    ...
    public void testParsePolygon() throws IOException, ParseException {
        ...
        com.colasoft.opensearch.geometry.Polygon p = new com.colasoft.opensearch.geometry.Polygon(
            new com.colasoft.opensearch.geometry.LinearRing(new double[] { 100d, 101d, 101d, 100d, 100d }, new double[] { 0d, 0d, 1d, 1d, 0d })
        );
    ...
    public void testParse3DPolygon() throws IOException, ParseException {
        ...
        com.colasoft.opensearch.geometry.Polygon p = new com.colasoft.opensearch.geometry.Polygon(
            new com.colasoft.opensearch.geometry.LinearRing(
    ...
    public void testParsePolygonWithHole() throws IOException, ParseException {
        ...
        com.colasoft.opensearch.geometry.LinearRing hole = new com.colasoft.opensearch.geometry.LinearRing(
    ...
    public void testParseMultiPoint() throws IOException, ParseException {
        ...
        assertGeometryEquals(
            new MultiPoint(Arrays.asList(new com.colasoft.opensearch.geometry.Point(100, 0), new com.colasoft.opensearch.geometry.Point(101, 1))),
            multiPointGeoJson,
            false
        );
    }
    ...
    public void testParseMultiPolygon() throws IOException, ParseException {
        ...
        com.colasoft.opensearch.geometry.MultiPolygon polygons = new com.colasoft.opensearch.geometry.MultiPolygon(
            Arrays.asList(
                new com.colasoft.opensearch.geometry.Polygon(
                    new com.colasoft.opensearch.geometry.LinearRing(
        ...
        com.colasoft.opensearch.geometry.LinearRing luceneHole = new com.colasoft.opensearch.geometry.LinearRing(
            new double[] { 100.8d, 100.8d, 100.2d, 100.2d, 100.8d },
            new double[] { 0.8d, 0.2d, 0.2d, 0.8d, 0.8d }
        );

        com.colasoft.opensearch.geometry.Polygon lucenePolygons = (new com.colasoft.opensearch.geometry.Polygon(
            new com.colasoft.opensearch.geometry.LinearRing(new double[] { 100d, 101d, 101d, 100d, 100d }, new double[] { 0d, 0d, 1d, 1d, 0d }),
    ...
    public void testParseGeometryCollection() throws IOException, ParseException {
        ...
        GeometryCollection<Geometry> geometryExpected = new GeometryCollection<>(
            Arrays.asList(
                new Line(new double[] { 100d, 101d }, new double[] { 0d, 1d }),
                new com.colasoft.opensearch.geometry.Point(102d, 2d),
                new com.colasoft.opensearch.geometry.MultiPolygon(
                    Arrays.asList(
                        new com.colasoft.opensearch.geometry.Polygon(
                            new com.colasoft.opensearch.geometry.LinearRing(
    ...
    public void testThatParserExtractsCorrectTypeAndCoordinatesFromArbitraryJson() throws IOException, ParseException {
        ...
        com.colasoft.opensearch.geometry.Point expectedPt = new com.colasoft.opensearch.geometry.Point(100, 0);
