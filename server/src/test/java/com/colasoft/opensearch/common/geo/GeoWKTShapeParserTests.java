...
import com.colasoft.opensearch.common.geo.builders.EnvelopeBuilder;
import com.colasoft.opensearch.common.geo.builders.GeometryCollectionBuilder;
...
import com.colasoft.opensearch.common.geo.builders.MultiPolygonBuilder;
import com.colasoft.opensearch.common.geo.builders.PointBuilder;
import com.colasoft.opensearch.common.geo.builders.PolygonBuilder;
import com.colasoft.opensearch.common.geo.builders.ShapeBuilder;
import com.colasoft.opensearch.common.geo.parsers.GeoWKTParser;
...
import com.colasoft.opensearch.index.mapper.GeoShapeFieldMapper;
...
import com.colasoft.opensearch.test.geo.RandomShapeGenerator;
...
public class GeoWKTShapeParserTests extends BaseGeoParsingTestCase {
    ...
    public void testParsePoint() throws IOException, ParseException {
        ...
        assertExpected(new com.colasoft.opensearch.geometry.Point(p.lon(), p.lat()), new PointBuilder().coordinate(c), false);
    ...
    public void testParseMultiPoint() throws IOException, ParseException {
        ...
        List<com.colasoft.opensearch.geometry.Point> points = new ArrayList<>(numPoints);
        for (int i = 0; i < numPoints; ++i) {
            Coordinate c = coordinates.get(i);
            points.add(new com.colasoft.opensearch.geometry.Point(c.x, c.y));
        }
    ...
    public void testParsePolygonWithHole() throws IOException, ParseException {
        ...
        com.colasoft.opensearch.geometry.Polygon p = new com.colasoft.opensearch.geometry.Polygon(
            new com.colasoft.opensearch.geometry.LinearRing(new double[] { 101d, 101d, 100d, 100d, 101d }, new double[] { 0d, 1d, 1d, 0d, 0d }),
    ...
    public void testParseEnvelope() throws IOException, ParseException {
        ...
        assertExpected(expected, builder, true);
        assertExpected(new com.colasoft.opensearch.geometry.Rectangle(r.minLon, r.maxLon, r.maxLat, r.minLat), builder, false);
        assertMalformed(builder);
    }
