...
import com.colasoft.opensearch.common.settings.AbstractScopedSettings.SettingUpdater;
import com.colasoft.opensearch.common.settings.Setting.ByteSizeValueParser;
import com.colasoft.opensearch.common.settings.Setting.DoubleParser;
import com.colasoft.opensearch.common.settings.Setting.FloatParser;
import com.colasoft.opensearch.common.settings.Setting.IntegerParser;
import com.colasoft.opensearch.common.settings.Setting.LongParser;
import com.colasoft.opensearch.common.settings.Setting.MemorySizeValueParser;
import com.colasoft.opensearch.common.settings.Setting.MinMaxTimeValueParser;
import com.colasoft.opensearch.common.settings.Setting.MinTimeValueParser;
import com.colasoft.opensearch.common.settings.Setting.Property;
import com.colasoft.opensearch.common.settings.Setting.RegexValidator;
...
import static com.colasoft.opensearch.index.IndexSettingsTests.newIndexMeta;
...
public class SettingTests extends OpenSearchTestCase {
    ...
    @TestLogging(value = "com.colasoft.opensearch.common.settings.IndexScopedSettings:INFO", reason = "to ensure we log INFO-level messages from IndexScopedSettings")
        ...
        try (MockLogAppender mockLogAppender = MockLogAppender.createForLoggers(logger)) {
            mockLogAppender.addExpectation(
                new MockLogAppender.SeenEventExpectation(
                    "message",
                    "com.colasoft.opensearch.common.settings.IndexScopedSettings",
                    Level.INFO,
