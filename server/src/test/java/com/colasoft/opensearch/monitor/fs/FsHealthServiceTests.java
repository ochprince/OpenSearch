...
package com.colasoft.opensearch.monitor.fs;
...
public class FsHealthServiceTests extends OpenSearchTestCase {
    ...
    @TestLogging(value = "com.colasoft.opensearch.monitor.fs:WARN", reason = "to ensure that we log on hung IO at WARN level")
