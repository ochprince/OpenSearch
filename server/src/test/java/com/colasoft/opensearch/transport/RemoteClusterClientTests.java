...
import static com.colasoft.opensearch.transport.RemoteClusterConnectionTests.startTransport;
...
public class RemoteClusterClientTests extends OpenSearchTestCase {
    ...
    @TestLogging(value = "com.colasoft.opensearch.transport.SniffConnectionStrategy:TRACE,com.colasoft.opensearch.transport.ClusterConnectionManager:TRACE", reason = "debug intermittent test failure")
