...
public class TcpTransportTests extends OpenSearchTestCase {
    ...
    @TestLogging(reason = "testing logging", value = "com.colasoft.opensearch.transport.TcpTransport:DEBUG")
    public void testExceptionHandling() throws IllegalAccessException {
        testExceptionHandling(
            false,
            new OpenSearchException("simulated"),
            true,
            new MockLogAppender.UnseenEventExpectation("message", "com.colasoft.opensearch.transport.TcpTransport", Level.ERROR, "*"),
            new MockLogAppender.UnseenEventExpectation("message", "com.colasoft.opensearch.transport.TcpTransport", Level.WARN, "*"),
            new MockLogAppender.UnseenEventExpectation("message", "com.colasoft.opensearch.transport.TcpTransport", Level.INFO, "*"),
            new MockLogAppender.UnseenEventExpectation("message", "com.colasoft.opensearch.transport.TcpTransport", Level.DEBUG, "*")
        );
        testExceptionHandling(
            new OpenSearchException("simulated"),
            new MockLogAppender.SeenEventExpectation(
                "message",
                "com.colasoft.opensearch.transport.TcpTransport",
                Level.WARN,
