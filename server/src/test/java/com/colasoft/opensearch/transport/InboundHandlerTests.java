...
public class InboundHandlerTests extends OpenSearchTestCase {
    ...
    public void setUp() throws Exception {
        ...
        channel = new FakeTcpChannel(randomBoolean(), buildNewFakeTransportAddress().address(), buildNewFakeTransportAddress().address()) {
            public void sendMessage(BytesReference reference, com.colasoft.opensearch.action.ActionListener<Void> listener) {
    ...
    public void testSendsErrorResponseToHandshakeFromCompatibleVersion() throws Exception {
        ...
        requestHeader.headers = Tuple.tuple(com.colasoft.opensearch.common.collect.Map.of(), com.colasoft.opensearch.common.collect.Map.of());
        requestHeader.features = com.colasoft.opensearch.common.collect.Set.of();
        handler.inboundMessage(channel, requestMessage);
