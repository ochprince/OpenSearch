        ...
        testCase((deferringCollector, delegate) -> new LeafBucketCollector() {
            ...
            equalTo(
                com.colasoft.opensearch.common.collect.Map.of(
                    0L,
                    com.colasoft.opensearch.common.collect.List.of(0, 1, 2, 3, 4, 5, 6, 7),
                    1L,
                    com.colasoft.opensearch.common.collect.List.of(8),
                    2L,
                    com.colasoft.opensearch.common.collect.List.of(9)
                )
            );
        });
    }
        ...
        testCase((deferringCollector, delegate) -> new LeafBucketCollector() {
            ...
            assertThat(
                ...
                equalTo(
                    com.colasoft.opensearch.common.collect.Map.of(
                        0L,
                        com.colasoft.opensearch.common.collect.List.of(4, 5, 6, 7),
                        1L,
                        com.colasoft.opensearch.common.collect.List.of(8),
                        2L,
                        com.colasoft.opensearch.common.collect.List.of(9)
        ...
        testCase((deferringCollector, delegate) -> new LeafBucketCollector() {
            ...
            assertThat(
                ...
                equalTo(
                    com.colasoft.opensearch.common.collect.Map.of(
                        0L,
                        com.colasoft.opensearch.common.collect.List.of(0, 1, 2, 3),
                        1L,
                        com.colasoft.opensearch.common.collect.List.of(8),
                        2L,
                        com.colasoft.opensearch.common.collect.List.of(9)
