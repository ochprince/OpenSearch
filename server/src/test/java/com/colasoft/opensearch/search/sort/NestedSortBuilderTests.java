...
public class NestedSortBuilderTests extends OpenSearchTestCase {
    ...
    public void testRewrite() throws IOException {
        QueryBuilder filterThatRewrites = new MatchNoneQueryBuilder() {
            @Override
            protected QueryBuilder doRewrite(com.colasoft.opensearch.index.query.QueryRewriteContext queryShardContext) throws IOException {
