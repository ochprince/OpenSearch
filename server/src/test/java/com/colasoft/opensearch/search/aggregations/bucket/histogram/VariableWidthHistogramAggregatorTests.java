...
import com.colasoft.opensearch.search.aggregations.support.AggregationInspectionHelper;
...
public class VariableWidthHistogramAggregatorTests extends AggregatorTestCase {
    ...
    public void testAsSubAggregation() throws IOException {
        ...
        CheckedConsumer<RandomIndexWriter, IOException> buildIndex = iw -> {
            iw.addDocument(
                com.colasoft.opensearch.common.collect.List.of(new SortedNumericDocValuesField("t", 1), new SortedNumericDocValuesField("v", 1))
            );
            iw.addDocument(
                com.colasoft.opensearch.common.collect.List.of(new SortedNumericDocValuesField("t", 1), new SortedNumericDocValuesField("v", 10))
            );
            iw.addDocument(
                com.colasoft.opensearch.common.collect.List.of(new SortedNumericDocValuesField("t", 1), new SortedNumericDocValuesField("v", 11))
            );

            iw.addDocument(
                com.colasoft.opensearch.common.collect.List.of(new SortedNumericDocValuesField("t", 2), new SortedNumericDocValuesField("v", 20))
            );
            iw.addDocument(
                com.colasoft.opensearch.common.collect.List.of(new SortedNumericDocValuesField("t", 2), new SortedNumericDocValuesField("v", 30))
            );
        };
        Consumer<LongTerms> verify = terms -> {
            ...
            assertThat(
                ...
                equalTo(com.colasoft.opensearch.common.collect.List.of(1.0, 10.5))
            );
            ...
            assertThat(
                ...
                equalTo(com.colasoft.opensearch.common.collect.List.of(20.0, 30))
            );
        };
    ...
    public void testHugeShardSize() throws Exception {
        ...
        testSearchCase(
            ...
            histogram -> assertThat(
                ...
                equalTo(com.colasoft.opensearch.common.collect.List.of(1.0, 2.0, 3.0))
            )
        );
    }
