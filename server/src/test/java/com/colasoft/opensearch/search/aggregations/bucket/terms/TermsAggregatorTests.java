...
import com.colasoft.opensearch.index.mapper.RangeFieldMapper;
...
import com.colasoft.opensearch.search.aggregations.bucket.MultiBucketsAggregation;
...
import com.colasoft.opensearch.test.geo.RandomGeoGenerator;
...
import static com.colasoft.opensearch.index.mapper.SeqNoFieldMapper.PRIMARY_TERM_NAME;
import static com.colasoft.opensearch.search.aggregations.AggregationBuilders.terms;
import static com.colasoft.opensearch.search.aggregations.PipelineAggregatorBuilders.bucketScript;
                ...
                try (IndexReader indexReader = maybeWrapReaderEs(indexWriter.getReader())) {
                    ...
                    for (TermsAggregatorFactory.ExecutionMode executionMode : TermsAggregatorFactory.ExecutionMode.values()) {
                        TermsAggregationBuilder aggregationBuilder = new TermsAggregationBuilder("_name").userValueTypeHint(
                            ValueType.STRING
                        ).executionHint(executionMode.toString()).field("string").order(BucketOrder.key(true));
                        MappedFieldType fieldType = new KeywordFieldMapper.KeywordFieldType("string");
