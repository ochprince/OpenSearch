...
public class FieldFetcherTests extends OpenSearchSingleNodeTestCase {
    ...
    public void testLeafValues() throws IOException {
        ...
        List<FieldAndFormat> fieldAndFormats = com.colasoft.opensearch.common.collect.List.of(
    ...
    public void testObjectValues() throws IOException {
        ...
        assertThat(rangeField.getValue(), equalTo(com.colasoft.opensearch.common.collect.Map.of("gte", 0.0f, "lte", 2.718f)));
    }
    ...
    public void testDateFormat() throws IOException {
        ...
        Map<String, DocumentField> fields = fetchFields(
            mapperService,
            source,
            com.colasoft.opensearch.common.collect.List.of(new FieldAndFormat("field", null), new FieldAndFormat("date_field", "yyyy/MM/dd"))
        );
        assertThat(fields.size(), equalTo(2));
    ...
    private static Map<String, DocumentField> fetchFields(MapperService mapperService, XContentBuilder source, String fieldPattern)
        ...
        List<FieldAndFormat> fields = com.colasoft.opensearch.common.collect.List.of(new FieldAndFormat(fieldPattern, null));
    ...
    private static Map<String, DocumentField> fetchFields(MapperService mapperService, XContentBuilder source, List<FieldAndFormat> fields)
        ...
        return fieldFetcher.fetch(sourceLookup, com.colasoft.opensearch.common.collect.Set.of());
    }
