...
package com.colasoft.opensearch.search.aggregations.bucket.missing;
...
import com.colasoft.opensearch.index.mapper.NumberFieldMapper.NumberType;
...
import com.colasoft.opensearch.search.lookup.LeafDocLookup;
...
import static com.colasoft.opensearch.common.lucene.search.Queries.newMatchAllQuery;
...
public class MissingAggregatorTests extends AggregatorTestCase {
    ...
    public void testMatchAllDocs() throws IOException {
        ...
        }, com.colasoft.opensearch.common.collect.List.of(aggFieldType, anotherFieldType));
    }
    ...
    public void testMultiValuedFieldWithFieldScriptWithParams() throws IOException {
        ...
        final Map<String, Object> params = com.colasoft.opensearch.common.collect.Map.of("field", "agg_field", "threshold", threshold);
    ...
    protected List<ValuesSourceType> getSupportedValuesSourceTypes() {
        return com.colasoft.opensearch.common.collect.List.of(
