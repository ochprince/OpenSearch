...
import com.colasoft.opensearch.search.aggregations.bucket.filter.InternalFilters.InternalBucket;
...
public class InternalFiltersTests extends InternalMultiBucketAggregationTestCase<InternalFilters> {
    ...
    public void testReducePipelinesReducesBucketPipelines() {
        ...
        PipelineTree tree = new PipelineTree(
            com.colasoft.opensearch.common.collect.Map.of(inner.getName(), new PipelineTree(emptyMap(), singletonList(mockPipeline))),
            emptyList()
        );
