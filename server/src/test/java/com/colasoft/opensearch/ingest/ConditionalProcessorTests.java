...
import com.colasoft.opensearch.script.IngestConditionalScript;
...
public class ConditionalProcessorTests extends OpenSearchTestCase {
    ...
    public void testPrecompiledError() {
        ...
        Script script = new Script(ScriptType.INLINE, "lang", "foo", com.colasoft.opensearch.common.collect.Map.of());
    ...
    public void testRuntimeCompileError() {
        ...
        storedScripts.put("foo", new StoredScriptSource("lang", "", com.colasoft.opensearch.common.collect.Map.of()));
        ...
        Script script = new Script(ScriptType.STORED, null, "foo", com.colasoft.opensearch.common.collect.Map.of());
        ...
        storedScripts.put("foo", new StoredScriptSource("lang", "changed", com.colasoft.opensearch.common.collect.Map.of()));
        IngestDocument ingestDoc = new IngestDocument(com.colasoft.opensearch.common.collect.Map.of(), com.colasoft.opensearch.common.collect.Map.of());
