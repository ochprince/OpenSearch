...
import static com.colasoft.opensearch.http.AbstractHttpServerTransport.resolvePublishPort;
...
public class AbstractHttpServerTransportTests extends OpenSearchTestCase {
    ...
    @TestLogging(value = "com.colasoft.opensearch.http.HttpTracer:trace", reason = "to ensure we log REST requests on TRACE level")
    public void testTracerLog() throws Exception {
        ...
        try (
            ...
            final String traceLoggerName = "com.colasoft.opensearch.http.HttpTracer";
