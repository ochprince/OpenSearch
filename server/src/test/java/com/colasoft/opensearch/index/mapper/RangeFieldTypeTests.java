...
import com.colasoft.opensearch.index.mapper.DateFieldMapper.DateFieldType;
import com.colasoft.opensearch.index.mapper.RangeFieldMapper.RangeFieldType;
...
public class RangeFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testFetchSourceValue() throws IOException {
        ...
        MappedFieldType longMapper = new RangeFieldMapper.Builder("field", RangeType.LONG, true, Version.V_EMPTY).build(context)
            .fieldType();
        Map<String, Object> longRange = com.colasoft.opensearch.common.collect.Map.of("gte", 3.14, "lt", "42.9");
        assertEquals(
            Collections.singletonList(com.colasoft.opensearch.common.collect.Map.of("gte", 3L, "lt", 42L)),
        ...
        Map<String, Object> dateRange = com.colasoft.opensearch.common.collect.Map.of("lt", "1990/12/29", "gte", 597429487111L);
        assertEquals(
            Collections.singletonList(com.colasoft.opensearch.common.collect.Map.of("lt", "1990/12/29", "gte", "1988/12/06")),
    ...
    public void testParseSourceValueWithFormat() throws IOException {
        ...
        MappedFieldType dateMapper = new RangeFieldMapper.Builder("field", RangeType.DATE, true, Version.V_EMPTY).format("strict_date_time")
            .build(context)
            .fieldType();
        Map<String, Object> dateRange = com.colasoft.opensearch.common.collect.Map.of("lt", "1990-12-29T00:00:00.000Z");
        assertEquals(
            Collections.singletonList(com.colasoft.opensearch.common.collect.Map.of("lt", "1990/12/29")),
            fetchSourceValue(dateMapper, dateRange, "yyy/MM/dd")
        );
        assertEquals(
            Collections.singletonList(com.colasoft.opensearch.common.collect.Map.of("lt", "662428800000")),
