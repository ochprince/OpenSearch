...
import static com.colasoft.opensearch.common.util.concurrent.OpenSearchExecutors.NODE_PROCESSORS_SETTING;
import static com.colasoft.opensearch.index.IndexSettingsTests.newIndexMeta;
import static com.colasoft.opensearch.index.MergeSchedulerConfig.MAX_MERGE_COUNT_SETTING;
import static com.colasoft.opensearch.index.MergeSchedulerConfig.MAX_THREAD_COUNT_SETTING;
...
public class MergeSchedulerSettingsTests extends OpenSearchTestCase {
    ...
    public void testUpdateAutoThrottleSettings() throws Exception {
        ...
        mockAppender.start();
        final Logger settingsLogger = LogManager.getLogger("com.colasoft.opensearch.common.settings.IndexScopedSettings");
