...
public class DynamicTemplatesTests extends MapperServiceTestCase {
    ...
    public void testSimple() throws Exception {
        String mapping = copyToStringFromClasspath("/com/colasoft/opensearch/index/mapper/dynamictemplate/simple/test-mapping.json");
        MapperService mapperService = createMapperService("_doc", mapping);
        String docJson = copyToStringFromClasspath("/com/colasoft/opensearch/index/mapper/dynamictemplate/simple/test-data.json");
