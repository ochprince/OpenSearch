...
import static com.colasoft.opensearch.index.MapperTestUtils.assertConflicts;
...
public class SourceFieldMapperTests extends OpenSearchSingleNodeTestCase {
    ...
    public void testNoFormat() throws Exception {
        String mapping = Strings.toString(
            XContentFactory.jsonBuilder().startObject().startObject("type").startObject("_source").endObject().endObject().endObject()
        );
