...
import static com.colasoft.opensearch.test.VersionUtils.randomVersion;

public class StoreTests extends OpenSearchTestCase {

    private static final IndexSettings INDEX_SETTINGS = IndexSettingsModule.newIndexSettings(
        "index",
        Settings.builder().put(IndexMetadata.SETTING_VERSION_CREATED, com.colasoft.opensearch.Version.CURRENT).build()
    );
    ...
    private static final Version MIN_SUPPORTED_LUCENE_VERSION = com.colasoft.opensearch.Version.CURRENT
    ...
    public void testStoreStats() throws IOException {
        ...
        Settings settings = Settings.builder()
            .put(IndexMetadata.SETTING_VERSION_CREATED, com.colasoft.opensearch.Version.CURRENT)
    ...
    public void testMetadataSnapshotStreaming() throws Exception {
        ...
        com.colasoft.opensearch.Version targetNodeVersion = randomVersion(random());
