...
import com.colasoft.opensearch.index.analysis.CustomAnalyzer;
import com.colasoft.opensearch.index.analysis.IndexAnalyzers;
import com.colasoft.opensearch.index.analysis.LowercaseNormalizer;
...
import com.colasoft.opensearch.index.mapper.KeywordFieldMapper.KeywordFieldType;
import com.colasoft.opensearch.index.mapper.MappedFieldType.Relation;
...
public class KeywordFieldTypeTests extends FieldTypeTestCase {
    ...
    private static IndexAnalyzers createIndexAnalyzers() {
        return new IndexAnalyzers(
            com.colasoft.opensearch.common.collect.Map.of("default", new NamedAnalyzer("default", AnalyzerScope.INDEX, new StandardAnalyzer())),
            com.colasoft.opensearch.common.collect.Map.ofEntries(
                com.colasoft.opensearch.common.collect.Map.entry(
                    "lowercase",
