...
import com.colasoft.opensearch.index.IndexingSlowLog.IndexingSlowLogMessage;
...
public class IndexingSlowLogTests extends OpenSearchTestCase {
    ...
    public void testLevelSetting() {
        ...
        try {
            ...
            assertThat(ex.getCause(), instanceOf(IllegalArgumentException.class));
            final IllegalArgumentException cause = (IllegalArgumentException) ex.getCause();
            assertThat(cause, hasToString(containsString("No enum constant com.colasoft.opensearch.index.SlowLogLevel.NOT A LEVEL")));
        }
        assertEquals(SlowLogLevel.TRACE, log.getLevel());
