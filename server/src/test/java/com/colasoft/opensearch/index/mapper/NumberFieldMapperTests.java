...
import com.colasoft.opensearch.index.mapper.NumberFieldTypeTests.OutOfRangeSpec;
import com.colasoft.opensearch.index.termvectors.TermVectorsService;
...
public class NumberFieldMapperTests extends AbstractNumericFieldMapperTestCase {
    ...
    protected Set<String> types() {
        return com.colasoft.opensearch.common.collect.Set.of("byte", "short", "integer", "long", "float", "double", "half_float");
    }

    @Override
    protected Set<String> wholeTypes() {
        return com.colasoft.opensearch.common.collect.Set.of("byte", "short", "integer", "long");
    }
