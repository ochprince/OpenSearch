...
import com.colasoft.opensearch.index.mapper.ObjectMapper.Dynamic;
...
public class ObjectMapperTests extends OpenSearchSingleNodeTestCase {
    ...
    public void testEmptyArrayProperties() throws Exception {
        String mapping = Strings.toString(
            XContentFactory.jsonBuilder().startObject().startObject("type").startArray("properties").endArray().endObject().endObject()
        );
    ...
    public void testMerge() throws IOException {
        ...
        String update = Strings.toString(
            XContentFactory.jsonBuilder().startObject().startObject("type").field("dynamic", "strict").endObject().endObject()
        );
