...
public class GenericStoreDynamicTemplateTests extends OpenSearchSingleNodeTestCase {
    public void testSimple() throws Exception {
        String mapping = copyToStringFromClasspath("/com/colasoft/opensearch/index/mapper/dynamictemplate/genericstore/test-mapping.json");
        ...
        byte[] json = copyToBytesFromClasspath("/com/colasoft/opensearch/index/mapper/dynamictemplate/genericstore/test-data.json");
