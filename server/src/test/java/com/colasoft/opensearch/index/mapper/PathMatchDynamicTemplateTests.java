...
public class PathMatchDynamicTemplateTests extends OpenSearchSingleNodeTestCase {
    public void testSimple() throws Exception {
        String mapping = copyToStringFromClasspath("/com/colasoft/opensearch/index/mapper/dynamictemplate/pathmatch/test-mapping.json");
        ...
        byte[] json = copyToBytesFromClasspath("/com/colasoft/opensearch/index/mapper/dynamictemplate/pathmatch/test-data.json");
