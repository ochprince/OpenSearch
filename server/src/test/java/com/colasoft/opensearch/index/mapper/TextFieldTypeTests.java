...
import com.colasoft.opensearch.common.lucene.BytesRefs;
import com.colasoft.opensearch.common.lucene.Lucene;
import com.colasoft.opensearch.common.lucene.search.AutomatonQueries;
import com.colasoft.opensearch.common.unit.Fuzziness;
import com.colasoft.opensearch.index.mapper.TextFieldMapper.TextFieldType;
...
public class TextFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testFetchSourceValue() throws IOException {
        ...
        assertEquals(com.colasoft.opensearch.common.collect.List.of("value"), fetchSourceValue(phraseFieldType, "value"));
        assertEquals(com.colasoft.opensearch.common.collect.List.of("42"), fetchSourceValue(phraseFieldType, 42L));
        assertEquals(com.colasoft.opensearch.common.collect.List.of("true"), fetchSourceValue(phraseFieldType, true));
    }
}
