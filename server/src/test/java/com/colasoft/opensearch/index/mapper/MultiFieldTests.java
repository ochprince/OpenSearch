...
public class MultiFieldTests extends OpenSearchSingleNodeTestCase {
    ...
    public void testMultiFieldMultiFields() throws Exception {
        String mapping = copyToStringFromClasspath("/com/colasoft/opensearch/index/mapper/multifield/test-multi-fields.json");
    ...
    private void testMultiField(String mapping) throws Exception {
        ...
        BytesReference json = new BytesArray(copyToBytesFromClasspath("/com/colasoft/opensearch/index/mapper/multifield/test-data.json"));
