...
import com.colasoft.opensearch.test.geo.RandomShapeGenerator.ShapeType;
...
public class GeoPolygonQueryBuilderTests extends AbstractQueryTestCase<GeoPolygonQueryBuilder> {
    ...
    public void testParsingAndToQueryParsingExceptions() throws IOException {
        String[] brokenFiles = new String[] {
            "/com/colasoft/opensearch/index/query/geo_polygon_exception_1.json",
            "/com/colasoft/opensearch/index/query/geo_polygon_exception_2.json",
            "/com/colasoft/opensearch/index/query/geo_polygon_exception_3.json",
            "/com/colasoft/opensearch/index/query/geo_polygon_exception_4.json",
            "/com/colasoft/opensearch/index/query/geo_polygon_exception_5.json" };
