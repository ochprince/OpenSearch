...
import com.colasoft.opensearch.index.mapper.LegacyGeoShapeFieldMapper.GeoShapeFieldType;
...
public class LegacyGeoShapeFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testFetchSourceValue() throws IOException {
        ...
        Map<String, Object> jsonLineString = com.colasoft.opensearch.common.collect.Map.of(
            "type",
            "LineString",
            "coordinates",
            Arrays.asList(Arrays.asList(42.0, 27.1), Arrays.asList(30.0, 50.0))
        );
        Map<String, Object> jsonPoint = com.colasoft.opensearch.common.collect.Map.of("type", "Point", "coordinates", Arrays.asList(14.0, 15.0));
