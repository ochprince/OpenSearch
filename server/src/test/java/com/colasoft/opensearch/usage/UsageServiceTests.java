...
package com.colasoft.opensearch.usage;
...
public class UsageServiceTests extends OpenSearchTestCase {
    ...
    /**
     * Test that we can not add a null reference to a {@link com.colasoft.opensearch.rest.RestHandler} to the {@link UsageService}.
     */
    ...
    /**
     * Test that we can not add an instance of a {@link com.colasoft.opensearch.rest.RestHandler} with no name to the {@link UsageService}.
     */
    public void testAHandlerWithNoName() {
        ...
        assertThat(
            e.getMessage(),
            equalTo("handler of type [com.colasoft.opensearch.usage.UsageServiceTests$MockRestHandler] does not have a name")
        );
    }

    /**
     * Test that we can add the same instance of a {@link com.colasoft.opensearch.rest.RestHandler} to the {@link UsageService} multiple times.
     */
    ...
    /**
     * Test that we can not add different instances of {@link com.colasoft.opensearch.rest.RestHandler} with the same name to the
     * {@link UsageService}.
     */
    public void testHandlersWithConflictingNamesButDifferentInstances() {
        ...
        final String expected = String.format(
            ...
            "com.colasoft.opensearch.usage.UsageServiceTests$MockRestHandler",
            name
        );
