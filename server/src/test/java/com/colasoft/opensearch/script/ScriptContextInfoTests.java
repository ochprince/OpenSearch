...
package com.colasoft.opensearch.script;
...
import com.colasoft.opensearch.script.ScriptContextInfo.ScriptMethodInfo;
import com.colasoft.opensearch.script.ScriptContextInfo.ScriptMethodInfo.ParameterInfo;
...
public class ScriptContextInfoTests extends OpenSearchTestCase {
    ...
    public void testCustomTypeContext() {
        String ct = "com.colasoft.opensearch.script.ScriptContextInfoTests$CustomType";
        String ct0 = ct + 0;
        String ct1 = ct + 1;
        String ct2 = ct + 2;
    ...
    public void testScriptContextInfoParser() throws IOException {
        String json = "{"
            ...
            + "        },"
            + "        {"
            + "          \"type\": \"com.colasoft.opensearch.index.similarity.ScriptedSimilarity$Query\","
            + "          \"name\": \"query\""
            + "        },"
            + "        {"
            + "          \"type\": \"com.colasoft.opensearch.index.similarity.ScriptedSimilarity$Field\","
            + "          \"name\": \"field\""
            + "        },"
            + "        {"
            + "          \"type\": \"com.colasoft.opensearch.index.similarity.ScriptedSimilarity$Term\","
            + "          \"name\": \"term\""
            + "        },"
            + "        {"
            + "          \"type\": \"com.colasoft.opensearch.index.similarity.ScriptedSimilarity$Doc\","
            + "          \"name\": \"doc\""
            + "        }"
            + "      ]"
            + "    },"
            ...
            new ScriptMethodInfo(
                ...
                Collections.unmodifiableList(
                    Arrays.asList(
                        ...
                        new ParameterInfo("com.colasoft.opensearch.index.similarity.ScriptedSimilarity$Query", "query"),
                        new ParameterInfo("com.colasoft.opensearch.index.similarity.ScriptedSimilarity$Field", "field"),
                        new ParameterInfo("com.colasoft.opensearch.index.similarity.ScriptedSimilarity$Term", "term"),
                        new ParameterInfo("com.colasoft.opensearch.index.similarity.ScriptedSimilarity$Doc", "doc")
                    )
                )
            ),
                ...
                Collections.unmodifiableList(
                    Arrays.asList(
                        ...
                        new ScriptMethodInfo(
                            "execute",
                            "double",
                            Collections.unmodifiableList(Arrays.asList(new ParameterInfo("double", "weight")))
                        )
                    )
                )
            )
