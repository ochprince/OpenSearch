...
public class MetadataDeleteIndexServiceTests extends OpenSearchTestCase {
    ...
    public void testDeleteBackingIndexForDataStream() {
        ...
        ClusterState before = DataStreamTestHelper.getClusterStateWithDataStreams(
            com.colasoft.opensearch.common.collect.List.of(new Tuple<>(dataStreamName, numBackingIndices)),
            com.colasoft.opensearch.common.collect.List.of()
        );
        ...
        ClusterState after = service.deleteIndices(before, com.colasoft.opensearch.common.collect.Set.of(indexToDelete));
    ...
    public void testDeleteCurrentWriteIndexForDataStream() {
        ...
        Exception e = expectThrows(
            ...
            () -> service.deleteIndices(before, com.colasoft.opensearch.common.collect.Set.of(indexToDelete))
        );
