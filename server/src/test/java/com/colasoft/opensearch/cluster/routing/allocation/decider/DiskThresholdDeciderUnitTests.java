...
import com.colasoft.opensearch.cluster.routing.RecoverySource.EmptyStoreRecoverySource;
import com.colasoft.opensearch.cluster.routing.RecoverySource.LocalShardsRecoverySource;
...
public class DiskThresholdDeciderUnitTests extends OpenSearchAllocationTestCase {
    ...
    public void testShardSizeAndRelocatingSize() {
        ...
        ClusterInfo info = new DiskThresholdDeciderTests.DevNullClusterInfo(
            ImmutableOpenMap.of(),
            ImmutableOpenMap.of(),
            shardSizes.build()
        );
