...
public class MasterServiceTests extends OpenSearchTestCase {
    ...
    */
    ...
    @TestLogging(value = "com.colasoft.opensearch.cluster.service:TRACE", reason = "to ensure that we log cluster state events on TRACE level")
    ...
    @TestLogging(value = "com.colasoft.opensearch.cluster.service:WARN", reason = "to ensure that we log cluster state events on WARN level")
