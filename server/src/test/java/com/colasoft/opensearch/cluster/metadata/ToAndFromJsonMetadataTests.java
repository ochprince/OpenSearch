...
import com.colasoft.opensearch.test.TestCustomMetadata;
...
import static com.colasoft.opensearch.cluster.DataStreamTestHelper.createFirstBackingIndex;
...
import static com.colasoft.opensearch.cluster.metadata.Metadata.CONTEXT_MODE_API;
...
public class ToAndFromJsonMetadataTests extends OpenSearchTestCase {
    ...
    public void testSimpleJsonFromAndTo() throws IOException {
        ...
        Metadata metadata = Metadata.builder()
            ...
            .put(idx1, false)
            .put(idx2, false)
            .put(new DataStream("data-stream1", createTimestampField("@timestamp"), com.colasoft.opensearch.common.collect.List.of(idx1.getIndex())))
            .put(new DataStream("data-stream2", createTimestampField("@timestamp"), com.colasoft.opensearch.common.collect.List.of(idx2.getIndex())))
            .build();
