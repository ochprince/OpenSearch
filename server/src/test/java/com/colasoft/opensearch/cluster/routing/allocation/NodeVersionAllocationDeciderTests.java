...
public class NodeVersionAllocationDeciderTests extends OpenSearchAllocationTestCase {
    ...
    public void testRebalanceDoesNotAllocatePrimaryAndReplicasOnDifferentVersionNodes() {
        ...
        RoutingTable routingTable = RoutingTable.builder()
            ...
            .build();
        ClusterState state = ClusterState.builder(com.colasoft.opensearch.cluster.ClusterName.CLUSTER_NAME_SETTING.getDefault(Settings.EMPTY))
            .metadata(metadata)
            .routingTable(routingTable)
    ...
    public void testMessages() {
        ...
        final com.colasoft.opensearch.cluster.ClusterName clusterName = com.colasoft.opensearch.cluster.ClusterName.CLUSTER_NAME_SETTING.getDefault(
            Settings.EMPTY
        );
