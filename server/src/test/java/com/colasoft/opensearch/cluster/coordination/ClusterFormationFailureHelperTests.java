...
import static com.colasoft.opensearch.cluster.coordination.ClusterBootstrapService.INITIAL_MASTER_NODES_SETTING;
...
public class ClusterFormationFailureHelperTests extends OpenSearchTestCase {
    ...
    public void testDescriptionOnUnhealthyNodes() {
        ...
        final DiscoveryNode clusterManagerNode = new DiscoveryNode(
            ...
            emptyMap(),
            com.colasoft.opensearch.common.collect.Set.of(DiscoveryNodeRole.CLUSTER_MANAGER_ROLE),
            Version.CURRENT
        );
