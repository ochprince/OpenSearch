...
import static com.colasoft.opensearch.cluster.DataStreamTestHelper.createBackingIndex;
...
import static com.colasoft.opensearch.cluster.metadata.Metadata.Builder.validateDataStreams;
...
public class MetadataTests extends OpenSearchTestCase {
    ...
    public void testBuilderRejectsDataStreamThatConflictsWithIndex() {
        ...
        Metadata.Builder b = Metadata.builder()
            ...
            .put(new DataStream(dataStreamName, createTimestampField("@timestamp"), com.colasoft.opensearch.common.collect.List.of(idx.getIndex())));
        ...
        Metadata.Builder b = Metadata.builder()
            ...
            .put(
                new DataStream(
                    ...
                    com.colasoft.opensearch.common.collect.List.of(validIdx.getIndex())
                )
            );
    ...
    public void testValidateDataStreamsThrowsExceptionOnConflict() {
        ...
        DataStreamMetadata dataStreamMetadata = new DataStreamMetadata(com.colasoft.opensearch.common.collect.Map.of(dataStreamName, dataStream));
