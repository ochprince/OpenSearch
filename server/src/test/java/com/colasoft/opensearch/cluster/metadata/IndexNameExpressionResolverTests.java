...
import com.colasoft.opensearch.cluster.metadata.IndexMetadata.State;
...
import static com.colasoft.opensearch.cluster.metadata.IndexMetadata.INDEX_HIDDEN_SETTING;
import static com.colasoft.opensearch.cluster.metadata.IndexNameExpressionResolver.SYSTEM_INDEX_ACCESS_CONTROL_HEADER_KEY;
        ...
        Metadata.Builder mdBuilder = Metadata.builder()
            ...
            .put(
                new DataStream(
                    ...
                    com.colasoft.opensearch.common.collect.List.of(backingIndex.getIndex()),
                    1
                )
            );
        ClusterState state = ClusterState.builder(new ClusterName("_name")).metadata(mdBuilder).build();
        ...
        Metadata.Builder mdBuilder = Metadata.builder()
            ...
            .put(
                new DataStream(
                    dataStreamName,
                    createTimestampField("@timestamp"),
                    com.colasoft.opensearch.common.collect.List.of(index1.getIndex(), index2.getIndex()),
                    2
                )
            );
        ClusterState state = ClusterState.builder(new ClusterName("_name")).metadata(mdBuilder).build();
        ...
        Metadata.Builder mdBuilder = Metadata.builder()
            ...
            .put(
                new DataStream(
                    dataStream2,
                    createTimestampField("@timestamp"),
                    com.colasoft.opensearch.common.collect.List.of(index3.getIndex(), index4.getIndex())
                )
            );
