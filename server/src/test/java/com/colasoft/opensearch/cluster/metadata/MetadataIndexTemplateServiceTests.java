...
import com.colasoft.opensearch.cluster.metadata.MetadataIndexTemplateService.PutRequest;
...
import com.colasoft.opensearch.index.mapper.MapperParsingException;
...
import static com.colasoft.opensearch.common.settings.Settings.builder;
import static com.colasoft.opensearch.env.Environment.PATH_HOME_SETTING;
import static com.colasoft.opensearch.index.mapper.DataStreamFieldMapper.Defaults.TIMESTAMP_FIELD;
import static com.colasoft.opensearch.indices.ShardLimitValidatorTests.createTestShardLimitService;
...
public class MetadataIndexTemplateServiceTests extends OpenSearchSingleNodeTestCase {
    ...
    public void testUpdateComponentTemplateWithIndexHiddenSetting() throws Exception {
        ...
        ComposableIndexTemplate firstGlobalIndexTemplate = new ComposableIndexTemplate(
            com.colasoft.opensearch.common.collect.List.of("*"),
            template,
            com.colasoft.opensearch.common.collect.List.of("foo"),
            1L,
            null,
            null,
            null
    ...
    public void testPutGlobalV2TemplateWhichResolvesIndexHiddenSetting() throws Exception {
        ...
        ComposableIndexTemplate globalIndexTemplate = new ComposableIndexTemplate(
            com.colasoft.opensearch.common.collect.List.of("*"),
            null,
            com.colasoft.opensearch.common.collect.List.of("ct-with-index-hidden-setting"),
            null,
            null,
            null,
            null
    ...
    public void testFindV2InvalidGlobalTemplate() {
        ...
        try {
            ...
            ComposableIndexTemplate invalidGlobalTemplate = new ComposableIndexTemplate(
                ...
                com.colasoft.opensearch.common.collect.List.of("ct"),
                5L,
                1L,
                null,
                null
            ...
            Metadata invalidGlobalTemplateMetadata = Metadata.builder()
                .putCustom(
                    ...
                    new ComposableIndexTemplateMetadata(
                        com.colasoft.opensearch.common.collect.Map.of("invalid_global_template", invalidGlobalTemplate)
                    )
                )
                .build();
    ...
    public void testDefinedTimestampMappingIsAddedForDataStreamTemplates() throws Exception {
        ...
        {
            ComposableIndexTemplate it = new ComposableIndexTemplate(
                com.colasoft.opensearch.common.collect.List.of("logs*"),
                new Template(
                    null,
                    new CompressedXContent(
                        "{\n"
                ...
                com.colasoft.opensearch.common.collect.List.of("ct1"),
                0L,
                1L,
                null,
            ...
            List<Map<String, Object>> parsedMappings = mappings.stream().map(m -> {
                try {
                    return MapperService.parseMapping(new NamedXContentRegistry(com.colasoft.opensearch.common.collect.List.of()), m.string());
                } catch (Exception e) {
                    logger.error(e);
                    fail("failed to parse mappings: " + m.string());
                    return null;
            ...
            Map<String, Object> firstParsedMapping = com.colasoft.opensearch.common.collect.Map.of(
                "_doc",
                com.colasoft.opensearch.common.collect.Map.of(
                    "properties",
                    com.colasoft.opensearch.common.collect.Map.of(TIMESTAMP_FIELD.getName(), com.colasoft.opensearch.common.collect.Map.of("type", "date"))
                )
            );
            assertThat(parsedMappings.get(0), equalTo(firstParsedMapping));

            Map<String, Object> secondMapping = com.colasoft.opensearch.common.collect.Map.of(
                "_doc",
                com.colasoft.opensearch.common.collect.Map.of(
                    "properties",
                    com.colasoft.opensearch.common.collect.Map.of("field1", com.colasoft.opensearch.common.collect.Map.of("type", "keyword"))
                )
            );
            assertThat(parsedMappings.get(1), equalTo(secondMapping));

            Map<String, Object> thirdMapping = com.colasoft.opensearch.common.collect.Map.of(
                "_doc",
                com.colasoft.opensearch.common.collect.Map.of(
                    "properties",
                    com.colasoft.opensearch.common.collect.Map.of("field2", com.colasoft.opensearch.common.collect.Map.of("type", "integer"))
                )
            );
...

        {
            ...
            ComposableIndexTemplate it = new ComposableIndexTemplate(
                com.colasoft.opensearch.common.collect.List.of("timeseries*"),
                new Template(
                    null,
                    new CompressedXContent(
                        "{\n"
            ...
            Map<String, Object> firstMapping = com.colasoft.opensearch.common.collect.Map.of(
                "_doc",
                com.colasoft.opensearch.common.collect.Map.of(
                    "properties",
                    com.colasoft.opensearch.common.collect.Map.of("field1", com.colasoft.opensearch.common.collect.Map.of("type", "keyword"))
            ...
            firstMapping = com.colasoft.opensearch.common.collect.Map.of(
                "_doc",
                com.colasoft.opensearch.common.collect.Map.of(
                    "properties",
                    com.colasoft.opensearch.common.collect.Map.of("field1", com.colasoft.opensearch.common.collect.Map.of("type", "keyword"))
            ...
            secondMapping = com.colasoft.opensearch.common.collect.Map.of(
                "_doc",
                com.colasoft.opensearch.common.collect.Map.of(
                    "properties",
                    com.colasoft.opensearch.common.collect.Map.of("field2", com.colasoft.opensearch.common.collect.Map.of("type", "integer"))
            ...
            Map<String, Object> secondMapping = com.colasoft.opensearch.common.collect.Map.of(
                ...
                com.colasoft.opensearch.common.collect.Map.of(
                    ...
                    com.colasoft.opensearch.common.collect.Map.of(
                        ...
                        com.colasoft.opensearch.common.collect.Map.of("type", "date_nanos")
                    )
                )
            );
            assertThat(parsedMappings.get(1), equalTo(secondMapping));
    ...
    private static List<Throwable> putTemplate(NamedXContentRegistry xContentRegistry, PutRequest request) {
        ...
        ClusterState clusterState = ClusterState.builder(com.colasoft.opensearch.cluster.ClusterName.CLUSTER_NAME_SETTING.getDefault(Settings.EMPTY))
            .metadata(metadata)
            .build();
