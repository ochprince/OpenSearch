...
import com.colasoft.opensearch.cluster.metadata.IndexNameExpressionResolver.Context;
import com.colasoft.opensearch.cluster.metadata.IndexNameExpressionResolver.DateMathExpressionResolver;
...
public class DateMathExpressionResolverTests extends OpenSearchTestCase {
    ...
    public void testExpression_MixedArray() throws Exception {
        List<String> result = expressionResolver.resolve(
            context,
