...
import static com.colasoft.opensearch.cluster.ClusterState.builder;
import static com.colasoft.opensearch.cluster.OpenSearchAllocationTestCase.createAllocationService;
...
public class DecommissionServiceTests extends OpenSearchTestCase {
    ...
    private ClusterState addDataNodes(ClusterState clusterState, String zone, String... nodeIds) {
        ...
        com.colasoft.opensearch.common.collect.List.of(nodeIds).forEach(nodeId -> nodeBuilder.add(newDataNode(nodeId, singletonMap("zone", zone))));
    ...
    private ClusterState addClusterManagerNodes(ClusterState clusterState, String zone, String... nodeIds) {
        DiscoveryNodes.Builder nodeBuilder = DiscoveryNodes.builder(clusterState.nodes());
        com.colasoft.opensearch.common.collect.List.of(nodeIds)
    ...
    private ClusterState removeNodes(ClusterState clusterState, String... nodeIds) {
        ...
        com.colasoft.opensearch.common.collect.List.of(nodeIds).forEach(nodeBuilder::remove);
