...
import static com.colasoft.opensearch.cluster.NodeConnectionsService.CLUSTER_NODE_RECONNECT_INTERVAL_SETTING;
...
public class NodeConnectionsServiceTests extends OpenSearchTestCase {
    ...
    @TestLogging(reason = "testing that DEBUG-level logging is reasonable", value = "com.colasoft.opensearch.cluster.NodeConnectionsService:DEBUG")
    public void testDebugLogging() throws IllegalAccessException {
        ...
        final Logger logger = LogManager.getLogger("com.colasoft.opensearch.cluster.NodeConnectionsService");
                ...
                if (disconnectedNodes.contains(targetNode)) {
                    appender.addExpectation(
                        new MockLogAppender.SeenEventExpectation(
                            ...
                            "com.colasoft.opensearch.cluster.NodeConnectionsService",
                            Level.DEBUG,
                            "connecting to " + targetNode
                        )
                    );
