...
import com.colasoft.opensearch.indices.InvalidAliasNameException;
...
import static com.colasoft.opensearch.cluster.metadata.IndexMetadata.INDEX_NUMBER_OF_ROUTING_SHARDS_SETTING;
import static com.colasoft.opensearch.cluster.metadata.IndexMetadata.INDEX_NUMBER_OF_SHARDS_SETTING;
import static com.colasoft.opensearch.cluster.metadata.IndexMetadata.INDEX_READ_ONLY_BLOCK;
...
import static com.colasoft.opensearch.cluster.metadata.IndexMetadata.SETTING_READ_ONLY;
...
import static com.colasoft.opensearch.cluster.metadata.IndexMetadata.SETTING_REMOTE_TRANSLOG_BUFFER_INTERVAL;
import static com.colasoft.opensearch.cluster.metadata.IndexMetadata.SETTING_REMOTE_TRANSLOG_STORE_ENABLED;
import static com.colasoft.opensearch.cluster.metadata.IndexMetadata.SETTING_REMOTE_TRANSLOG_STORE_REPOSITORY;
...
import static com.colasoft.opensearch.cluster.metadata.MetadataCreateIndexService.aggregateIndexSettings;
import static com.colasoft.opensearch.cluster.metadata.MetadataCreateIndexService.buildIndexMetadata;
import static com.colasoft.opensearch.cluster.metadata.MetadataCreateIndexService.clusterStateCreateIndex;
import static com.colasoft.opensearch.cluster.metadata.MetadataCreateIndexService.getIndexNumberOfRoutingShards;
import static com.colasoft.opensearch.cluster.metadata.MetadataCreateIndexService.parseV1Mappings;
import static com.colasoft.opensearch.cluster.metadata.MetadataCreateIndexService.resolveAndValidateAliases;
import static com.colasoft.opensearch.index.IndexSettings.INDEX_SOFT_DELETES_SETTING;
import static com.colasoft.opensearch.indices.IndicesService.CLUSTER_REMOTE_STORE_REPOSITORY_SETTING;
import static com.colasoft.opensearch.indices.IndicesService.CLUSTER_REMOTE_TRANSLOG_REPOSITORY_SETTING;
import static com.colasoft.opensearch.indices.IndicesService.CLUSTER_REMOTE_STORE_ENABLED_SETTING;
