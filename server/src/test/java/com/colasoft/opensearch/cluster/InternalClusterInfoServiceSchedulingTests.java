...
import static com.colasoft.opensearch.cluster.InternalClusterInfoService.INTERNAL_CLUSTER_INFO_UPDATE_INTERVAL_SETTING;
            ...
            if (request instanceof NodesStatsRequest || request instanceof IndicesStatsRequest) {
                ...
                listener.onFailure(
                    new ClusterBlockException(
                        com.colasoft.opensearch.common.collect.Set.of(NoClusterManagerBlockService.NO_CLUSTER_MANAGER_BLOCK_ALL)
                    )
                );
            } else {
