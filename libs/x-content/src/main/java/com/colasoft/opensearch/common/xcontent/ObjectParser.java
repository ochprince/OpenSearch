...
import static com.colasoft.opensearch.common.xcontent.XContentParser.Token.START_ARRAY;
import static com.colasoft.opensearch.common.xcontent.XContentParser.Token.START_OBJECT;
import static com.colasoft.opensearch.common.xcontent.XContentParser.Token.VALUE_BOOLEAN;
import static com.colasoft.opensearch.common.xcontent.XContentParser.Token.VALUE_EMBEDDED_OBJECT;
import static com.colasoft.opensearch.common.xcontent.XContentParser.Token.VALUE_NULL;
import static com.colasoft.opensearch.common.xcontent.XContentParser.Token.VALUE_NUMBER;
import static com.colasoft.opensearch.common.xcontent.XContentParser.Token.VALUE_STRING;
...
public final class ObjectParser<Value, Context> extends AbstractObjectParser<Value, Context>
    ...
    private void parseValue(XContentParser parser, FieldParser fieldParser, String currentFieldName, Value value, Context context)
        ...
        try {
            ...
            throw new XContentParseException(
                parser.getTokenLocation(),
                "[" + name + "] failed to parse field [" + currentFieldName + "]",
                ex
            );
        }
    }
