...
package com.colasoft.opensearch.geometry;
...
import com.colasoft.opensearch.test.AbstractWireTestCase;
    ...
    public static void testVisitor(Geometry geom) {
        ...
        Object result = geom.visit(new GeometryVisitor<Object, RuntimeException>() {
            private Object verify(Geometry geometry, String expectedClass) {
                ...
                assertEquals(geometry.getClass().getName(), "com.colasoft.opensearch.geometry." + expectedClass);
                return "result";
            }
