...
package com.colasoft.opensearch.secure_sm;
...
public class SecureSMTests extends TestCase {
    ...
    public void testClassCanExit() {
        ...
        assertTrue(SecureSM.classCanExit("com.colasoft.opensearch.Foo", new String[] { "com.colasoft.opensearch.Foo" }));
        assertFalse(SecureSM.classCanExit("com.colasoft.opensearch.Foo", new String[] { "com.colasoft.opensearch.Bar" }));
    }
