...
package com.colasoft.opensearch.grok;

import com.colasoft.opensearch.grok.GrokCaptureConfig.NativeExtracterMap;
...
import static com.colasoft.opensearch.grok.GrokCaptureType.BOOLEAN;
import static com.colasoft.opensearch.grok.GrokCaptureType.DOUBLE;
import static com.colasoft.opensearch.grok.GrokCaptureType.FLOAT;
import static com.colasoft.opensearch.grok.GrokCaptureType.INTEGER;
import static com.colasoft.opensearch.grok.GrokCaptureType.LONG;
import static com.colasoft.opensearch.grok.GrokCaptureType.STRING;
...
public class GrokTests extends OpenSearchTestCase {
    public void testMatchWithoutCaptures() {
        ...
        assertThat(grok.captures("value"), equalTo(com.colasoft.opensearch.common.collect.Map.of()));
        assertThat(grok.captures("prefix_value"), equalTo(com.colasoft.opensearch.common.collect.Map.of()));
    ...
    public void testCaputuresBytes() {
        ...
        assertThat(captureBytes(grok, utf8, 0, utf8.length), equalTo(com.colasoft.opensearch.common.collect.Map.of("n", 10)));
        assertThat(captureBytes(grok, utf8, 0, 1), equalTo(com.colasoft.opensearch.common.collect.Map.of("n", 1)));
        utf8 = "10 11 12".getBytes(StandardCharsets.UTF_8);
        assertThat(captureBytes(grok, utf8, 0, 2), equalTo(com.colasoft.opensearch.common.collect.Map.of("n", 10)));
        assertThat(captureBytes(grok, utf8, 3, 2), equalTo(com.colasoft.opensearch.common.collect.Map.of("n", 11)));
        assertThat(captureBytes(grok, utf8, 6, 2), equalTo(com.colasoft.opensearch.common.collect.Map.of("n", 12)));
    }
    ...
    public void testSimpleSyslogLine() {
        ...
        assertCaptureConfig(
            grok,
            com.colasoft.opensearch.common.collect.Map.ofEntries(
                com.colasoft.opensearch.common.collect.Map.entry("facility", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("logsource", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("message", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("pid", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("priority", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("program", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("timestamp", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("timestamp8601", STRING)
            )
        );
    ...
    public void testSyslog5424Line() {
        ...
        assertCaptureConfig(
            grok,
            com.colasoft.opensearch.common.collect.Map.ofEntries(
                com.colasoft.opensearch.common.collect.Map.entry("syslog5424_app", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("syslog5424_host", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("syslog5424_msg", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("syslog5424_msgid", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("syslog5424_pri", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("syslog5424_proc", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("syslog5424_sd", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("syslog5424_ts", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("syslog5424_ver", STRING)
            )
        );
        Map<String, Object> matches = grok.captures(line);
    ...
    public void testDatePattern() {
        ...
        assertCaptureConfig(grok, com.colasoft.opensearch.common.collect.Map.of("timestamp", STRING));
        Map<String, Object> matches = grok.captures(line);
    ...
    public void testNilCoercedValues() {
        ...
        assertCaptureConfig(grok, com.colasoft.opensearch.common.collect.Map.of("duration", FLOAT));
    ...
    public void testNilWithNoCoercion() {
        ...
        assertCaptureConfig(grok, com.colasoft.opensearch.common.collect.Map.of("duration", STRING));
        Map<String, Object> matches = grok.captures("test 28.4ms");
    ...
    public void testUnicodeSyslog() {
        ...
        assertCaptureConfig(
            grok,
            com.colasoft.opensearch.common.collect.Map.ofEntries(
                com.colasoft.opensearch.common.collect.Map.entry("syslog_hostname", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("syslog_message", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("syslog_pid", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("syslog_pri", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("syslog_program", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("syslog_timestamp", STRING)
            )
        );
    ...
    public void testNamedFieldsWithWholeTextMatch() {
        ...
        assertCaptureConfig(grok, com.colasoft.opensearch.common.collect.Map.of("stimestamp", STRING));
    ...
    public void testWithOniguramaNamedCaptures() {
        ...
        assertCaptureConfig(grok, com.colasoft.opensearch.common.collect.Map.of("foo", STRING));
    ...
    public void testISO8601() {
        ...
        assertCaptureConfig(grok, com.colasoft.opensearch.common.collect.Map.of());
    ...
    public void testNoNamedCaptures() {
        ...
        assertCaptureConfig(g, com.colasoft.opensearch.common.collect.Map.of("EXCITED_NAME_0", STRING, "NAME_21", STRING, "NAME_22", STRING));
    ...
    public void testBooleanCaptures() {
        ...
        assertCaptureConfig(g, com.colasoft.opensearch.common.collect.Map.of("name", STRING, "status", BOOLEAN));
    ...
    public void testNumericCaptures() {
        ...
        assertCaptureConfig(g, com.colasoft.opensearch.common.collect.Map.of("bytes", FLOAT, "id", LONG, "rating", DOUBLE));
    ...
    public void testNumericCapturesCoercion() {
        ...
        Grok g = new Grok(bank, pattern, logger::warn);
        assertCaptureConfig(g, com.colasoft.opensearch.common.collect.Map.of("bytes", FLOAT, "status", STRING));
    ...
    public void testGarbageTypeNameBecomesString() {
        ...
        Grok g = new Grok(bank, pattern, logger::warn);
        assertCaptureConfig(g, com.colasoft.opensearch.common.collect.Map.of("f", STRING));
        assertThat(g.captures("12009.34"), equalTo(com.colasoft.opensearch.common.collect.Map.of("f", "12009.34")));
    }
    ...
    public void testApacheLog() {
        ...
        assertCaptureConfig(
            grok,
            com.colasoft.opensearch.common.collect.Map.ofEntries(
                com.colasoft.opensearch.common.collect.Map.entry("agent", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("auth", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("bytes", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("clientip", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("httpversion", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("ident", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("rawrequest", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("referrer", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("request", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("response", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("timestamp", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("verb", STRING)
            )
        );
    ...
    public void testComplete() {
        ...
        assertCaptureConfig(
            ...
            com.colasoft.opensearch.common.collect.Map.ofEntries(
                com.colasoft.opensearch.common.collect.Map.entry("agent", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("auth", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("bytes", INTEGER),
                com.colasoft.opensearch.common.collect.Map.entry("clientip", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("httpversion", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("ident", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("referrer", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("request", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("response", INTEGER),
                com.colasoft.opensearch.common.collect.Map.entry("timestamp", STRING),
                com.colasoft.opensearch.common.collect.Map.entry("verb", STRING)
            )
        );
    ...
    public void testMultipleNamedCapturesWithSameName() {
        ...
        assertCaptureConfig(grok, com.colasoft.opensearch.common.collect.Map.of("num", STRING));
