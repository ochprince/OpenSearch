...
import static com.colasoft.opensearch.geometry.utils.Geohash.PRECISION;
...
public class GeoHashGridIT extends GeoModulePluginIntegTestCase {
    ...
    public void testFiltered() throws Exception {
        ...
        for (int precision = 1; precision <= PRECISION; precision++) {
            SearchResponse response = client().prepareSearch("idx")
                .addAggregation(
                    com.colasoft.opensearch.search.aggregations.AggregationBuilders.filter("filtered", bbox)
