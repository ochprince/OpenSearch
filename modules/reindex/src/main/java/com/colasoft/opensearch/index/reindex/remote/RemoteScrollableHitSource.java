...
import static com.colasoft.opensearch.index.reindex.remote.RemoteResponseParsers.MAIN_ACTION_PARSER;
import static com.colasoft.opensearch.index.reindex.remote.RemoteResponseParsers.RESPONSE_PARSER;
...
public class RemoteScrollableHitSource extends ScrollableHitSource {
    ...
    protected void clearScroll(String scrollId, Runnable onCompletion) {
        client.performRequestAsync(RemoteRequestBuilders.clearScroll(scrollId, remoteVersion), new ResponseListener() {
            @Override
            public void onSuccess(com.colasoft.opensearch.client.Response response) {
