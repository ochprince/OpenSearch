...
import com.colasoft.opensearch.client.HeapBufferedAsyncResponseConsumer;
...
import com.colasoft.opensearch.index.reindex.RejectAwareActionListener;
...
public class RemoteScrollableHitSourceTests extends OpenSearchTestCase {
    ...
    public void testParseRejection() throws Exception {
        ...
        Consumer<Response> checkResponse = r -> {
            ...
            assertEquals(
                "rejected execution of com.colasoft.opensearch.transport.TransportService$5@52d06af2 on "
                    + "OpenSearchThreadPoolExecutor[search, queue capacity = 1000, com.colasoft.opensearch.common.util.concurrent."
