...
import com.colasoft.opensearch.OpenSearchNetty4IntegTestCase;
...
import com.colasoft.opensearch.transport.TransportLogger;
...
public class OpenSearchLoggingHandlerIT extends OpenSearchNetty4IntegTestCase {
    ...
    @TestLogging(value = "com.colasoft.opensearch.transport.netty4.OpenSearchLoggingHandler:trace,com.colasoft.opensearch.transport.TransportLogger:trace", reason = "to ensure we log network events on TRACE level")
    ...
    @TestLogging(value = "com.colasoft.opensearch.transport.TcpTransport:DEBUG", reason = "to ensure we log connection events on DEBUG level")
