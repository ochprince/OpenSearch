...
public class BWCTemplateTests extends OpenSearchSingleNodeTestCase {
    ...
    public void testBeatsTemplatesBWC() throws Exception {
        byte[] metricBeat = copyToBytesFromClasspath("/com/colasoft/opensearch/index/mapper/metricbeat-6.0.template.json");
        byte[] packetBeat = copyToBytesFromClasspath("/com/colasoft/opensearch/index/mapper/packetbeat-6.0.template.json");
        byte[] fileBeat = copyToBytesFromClasspath("/com/colasoft/opensearch/index/mapper/filebeat-6.0.template.json");
