...
import com.colasoft.opensearch.index.mapper.SearchAsYouTypeFieldMapper.Defaults;
import com.colasoft.opensearch.index.mapper.SearchAsYouTypeFieldMapper.PrefixFieldType;
import com.colasoft.opensearch.index.mapper.SearchAsYouTypeFieldMapper.SearchAsYouTypeFieldType;
import com.colasoft.opensearch.index.mapper.SearchAsYouTypeFieldMapper.ShingleFieldType;
...
public class SearchAsYouTypeFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testFetchSourceValue() throws IOException {
        ...
        assertEquals(com.colasoft.opensearch.common.collect.List.of("value"), fetchSourceValue(fieldType, "value"));
        assertEquals(com.colasoft.opensearch.common.collect.List.of("42"), fetchSourceValue(fieldType, 42L));
        assertEquals(com.colasoft.opensearch.common.collect.List.of("true"), fetchSourceValue(fieldType, true));
        ...
        assertEquals(com.colasoft.opensearch.common.collect.List.of("value"), fetchSourceValue(prefixFieldType, "value"));
        assertEquals(com.colasoft.opensearch.common.collect.List.of("42"), fetchSourceValue(prefixFieldType, 42L));
        assertEquals(com.colasoft.opensearch.common.collect.List.of("true"), fetchSourceValue(prefixFieldType, true));
        ...
        assertEquals(com.colasoft.opensearch.common.collect.List.of("value"), fetchSourceValue(shingleFieldType, "value"));
        assertEquals(com.colasoft.opensearch.common.collect.List.of("42"), fetchSourceValue(shingleFieldType, 42L));
        assertEquals(com.colasoft.opensearch.common.collect.List.of("true"), fetchSourceValue(shingleFieldType, true));
    }
}
