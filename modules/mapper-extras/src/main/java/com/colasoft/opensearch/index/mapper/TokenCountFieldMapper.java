...
import static com.colasoft.opensearch.common.xcontent.support.XContentMapValues.nodeIntegerValue;
    ...
    static class TokenCountFieldType extends NumberFieldMapper.NumberFieldType {
        ...
        public ValueFetcher valueFetcher(QueryShardContext context, SearchLookup searchLookup, String format) {
            if (hasDocValues() == false) {
                return lookup -> com.colasoft.opensearch.common.collect.List.of();
            }
