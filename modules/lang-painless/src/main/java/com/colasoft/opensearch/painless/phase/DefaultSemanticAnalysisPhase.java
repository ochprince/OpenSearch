...
import com.colasoft.opensearch.painless.AnalyzerCaster;
import com.colasoft.opensearch.painless.CompilerSettings;
import com.colasoft.opensearch.painless.FunctionRef;
import com.colasoft.opensearch.painless.Location;
import com.colasoft.opensearch.painless.Operation;
import com.colasoft.opensearch.painless.lookup.PainlessCast;
import com.colasoft.opensearch.painless.lookup.PainlessClassBinding;
import com.colasoft.opensearch.painless.lookup.PainlessConstructor;
import com.colasoft.opensearch.painless.lookup.PainlessField;
...
import com.colasoft.opensearch.painless.lookup.PainlessMethod;
import com.colasoft.opensearch.painless.lookup.def;
...
import com.colasoft.opensearch.painless.spi.annotation.NonDeterministicAnnotation;
import com.colasoft.opensearch.painless.symbol.Decorations;
import com.colasoft.opensearch.painless.symbol.Decorations.AllEscape;
import com.colasoft.opensearch.painless.symbol.Decorations.AnyBreak;
import com.colasoft.opensearch.painless.symbol.Decorations.AnyContinue;
import com.colasoft.opensearch.painless.symbol.Decorations.BeginLoop;
import com.colasoft.opensearch.painless.symbol.Decorations.BinaryType;
import com.colasoft.opensearch.painless.symbol.Decorations.CapturesDecoration;
import com.colasoft.opensearch.painless.symbol.Decorations.ComparisonType;
import com.colasoft.opensearch.painless.symbol.Decorations.CompoundType;
import com.colasoft.opensearch.painless.symbol.Decorations.ContinuousLoop;
import com.colasoft.opensearch.painless.symbol.Decorations.DefOptimized;
import com.colasoft.opensearch.painless.symbol.Decorations.DowncastPainlessCast;
import com.colasoft.opensearch.painless.symbol.Decorations.EncodingDecoration;
import com.colasoft.opensearch.painless.symbol.Decorations.Explicit;
import com.colasoft.opensearch.painless.symbol.Decorations.ExpressionPainlessCast;
import com.colasoft.opensearch.painless.symbol.Decorations.GetterPainlessMethod;
import com.colasoft.opensearch.painless.symbol.Decorations.InLoop;
import com.colasoft.opensearch.painless.symbol.Decorations.InstanceType;
import com.colasoft.opensearch.painless.symbol.Decorations.Internal;
import com.colasoft.opensearch.painless.symbol.Decorations.IterablePainlessMethod;
import com.colasoft.opensearch.painless.symbol.Decorations.LastLoop;
import com.colasoft.opensearch.painless.symbol.Decorations.LastSource;
import com.colasoft.opensearch.painless.symbol.Decorations.ListShortcut;
import com.colasoft.opensearch.painless.symbol.Decorations.LoopEscape;
import com.colasoft.opensearch.painless.symbol.Decorations.MapShortcut;
import com.colasoft.opensearch.painless.symbol.Decorations.MethodEscape;
import com.colasoft.opensearch.painless.symbol.Decorations.MethodNameDecoration;
import com.colasoft.opensearch.painless.symbol.Decorations.Negate;
import com.colasoft.opensearch.painless.symbol.Decorations.ParameterNames;
import com.colasoft.opensearch.painless.symbol.Decorations.PartialCanonicalTypeName;
import com.colasoft.opensearch.painless.symbol.Decorations.Read;
import com.colasoft.opensearch.painless.symbol.Decorations.ReferenceDecoration;
import com.colasoft.opensearch.painless.symbol.Decorations.ReturnType;
import com.colasoft.opensearch.painless.symbol.Decorations.SemanticVariable;
import com.colasoft.opensearch.painless.symbol.Decorations.SetterPainlessMethod;
import com.colasoft.opensearch.painless.symbol.Decorations.ShiftType;
import com.colasoft.opensearch.painless.symbol.Decorations.Shortcut;
import com.colasoft.opensearch.painless.symbol.Decorations.StandardConstant;
import com.colasoft.opensearch.painless.symbol.Decorations.StandardLocalFunction;
import com.colasoft.opensearch.painless.symbol.Decorations.StandardPainlessClassBinding;
import com.colasoft.opensearch.painless.symbol.Decorations.StandardPainlessConstructor;
import com.colasoft.opensearch.painless.symbol.Decorations.StandardPainlessField;
import com.colasoft.opensearch.painless.symbol.Decorations.StandardPainlessInstanceBinding;
import com.colasoft.opensearch.painless.symbol.Decorations.StandardPainlessMethod;
import com.colasoft.opensearch.painless.symbol.Decorations.StaticType;
import com.colasoft.opensearch.painless.symbol.Decorations.TargetType;
import com.colasoft.opensearch.painless.symbol.Decorations.TypeParameters;
import com.colasoft.opensearch.painless.symbol.Decorations.UnaryType;
import com.colasoft.opensearch.painless.symbol.Decorations.UpcastPainlessCast;
import com.colasoft.opensearch.painless.symbol.Decorations.ValueType;
import com.colasoft.opensearch.painless.symbol.Decorations.Write;
import com.colasoft.opensearch.painless.symbol.FunctionTable;
import com.colasoft.opensearch.painless.symbol.FunctionTable.LocalFunction;
import com.colasoft.opensearch.painless.symbol.ScriptScope;
import com.colasoft.opensearch.painless.symbol.SemanticScope;
import com.colasoft.opensearch.painless.symbol.SemanticScope.FunctionScope;
import com.colasoft.opensearch.painless.symbol.SemanticScope.LambdaScope;
import com.colasoft.opensearch.painless.symbol.SemanticScope.Variable;
...
import static com.colasoft.opensearch.painless.lookup.PainlessLookupUtility.typeToCanonicalTypeName;
import static com.colasoft.opensearch.painless.symbol.SemanticScope.newFunctionScope;
    ...
    public void visitRegex(ERegex userRegexNode, SemanticScope semanticScope) {
        ...
        try {
            ...
            throw new Location(location.getSourceName(), location.getOffset() + 1 + pse.getIndex()).createError(
                new IllegalArgumentException(
                    "invalid regular expression: " + "could not compile regex constant [" + pattern + "] with flags [" + flags + "]",
                    pse
                )
            );
        }
        ...
        if (prefixValueType != null && prefixValueType.getValueType() == def.class) {
            ...
            if (prefixValueType != null) {
                method = semanticScope.getScriptScope()
                    .getPainlessLookup()
                    .lookupPainlessMethod(prefixValueType.getValueType(), false, methodName, userArgumentsSize);
