...
import com.colasoft.opensearch.painless.PainlessError;
import com.colasoft.opensearch.painless.PainlessExplainError;
import com.colasoft.opensearch.painless.ScriptClassInfo;
import com.colasoft.opensearch.painless.ScriptClassInfo.MethodArgument;
...
import com.colasoft.opensearch.painless.symbol.Decorations.Converter;
        ...
        for (int i = 0; i < scriptScope.getScriptClassInfo().getGetMethods().size(); ++i) {
            ...
            if (scriptScope.getUsedVariables().contains(name)) {
                ...
                irInvokeCallMemberNode.setLocalFunction(
                    new LocalFunction(getMethod.getName(), returnType, Collections.emptyList(), true, false)
                );
