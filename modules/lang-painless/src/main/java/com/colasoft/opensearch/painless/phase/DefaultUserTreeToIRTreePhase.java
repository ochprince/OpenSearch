...
import com.colasoft.opensearch.painless.DefBootstrap;
...
import com.colasoft.opensearch.painless.WriterConstants;
...
import com.colasoft.opensearch.painless.ir.ConditionNode;
...
import com.colasoft.opensearch.painless.ir.ExpressionNode;
...
import com.colasoft.opensearch.painless.ir.IRNode;
...
import com.colasoft.opensearch.painless.ir.StoreNode;
...
import com.colasoft.opensearch.painless.lookup.PainlessLookup;
...
import com.colasoft.opensearch.painless.symbol.Decorations.AccessDepth;
...
import com.colasoft.opensearch.painless.symbol.Decorations.Compound;
...
import com.colasoft.opensearch.painless.symbol.Decorations.IRNodeDecoration;
...
public class DefaultUserTreeToIRTreePhase implements UserTreeVisitor<ScriptScope> {
    ...
    protected void injectBootstrapMethod(ScriptScope scriptScope) {
        ...
        try {
            ...
            irFunctionNode.getTypeParameters()
                .addAll(Arrays.asList(Lookup.class, String.class, MethodType.class, int.class, int.class, Object[].class));
            irFunctionNode.getParameterNames()
                .addAll(Arrays.asList("methodHandlesLookup", "name", "type", "initialDepth", "flavor", "args"));
