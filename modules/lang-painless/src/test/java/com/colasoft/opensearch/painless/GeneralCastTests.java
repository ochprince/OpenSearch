...
public class GeneralCastTests extends ScriptTestCase {
    ...
    public void testBoxedDefCalls() {
        ...
        assertEquals(2, exec("def f = new com.colasoft.opensearch.painless.FeatureTestObject(); f.i = (byte)2; f.i"));
        assertEquals(
            4.0,
            exec(
                "def x = new com.colasoft.opensearch.painless.FeatureTestObject(); "
        ...
        assertNull(exec("def f = new com.colasoft.opensearch.painless.FeatureTestObject(); f.i = null; f.i"));
