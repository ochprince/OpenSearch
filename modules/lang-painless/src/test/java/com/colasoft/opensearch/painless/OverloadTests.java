...
public class OverloadTests extends ScriptTestCase {
    ...
    public void testConstructor() {
        assertEquals(
            true,
            exec(
                "com.colasoft.opensearch.painless.FeatureTestObject f = new com.colasoft.opensearch.painless.FeatureTestObject();"
                    + "return f.x == 0 && f.y == 0;"
            )
        );
        assertEquals(
            true,
            exec(
                "com.colasoft.opensearch.painless.FeatureTestObject f = new com.colasoft.opensearch.painless.FeatureTestObject(1, 2);"
                    + "return f.x == 1 && f.y == 2;"
            )
        );
    }
    ...
    public void testStatic() {
        assertEquals(true, exec("return com.colasoft.opensearch.painless.FeatureTestObject.overloadedStatic();"));
        assertEquals(false, exec("return com.colasoft.opensearch.painless.FeatureTestObject.overloadedStatic(false);"));
    }
}
