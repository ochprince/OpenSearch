...
public class BasicExpressionTests extends ScriptTestCase {
    ...
    public void testNullSafeDeref() {
        ...
        // Read shortcut
        assertMustBeNullable("com.colasoft.opensearch.painless.FeatureTestObject a = null; return a?.x");
        assertMustBeNullable("com.colasoft.opensearch.painless.FeatureTestObject a = new com.colasoft.opensearch.painless.FeatureTestObject(); return a?.x");
        assertNull(exec("def    a = null;  return a?.x"));
        assertEquals(0, exec("def    a = new com.colasoft.opensearch.painless.FeatureTestObject(); return a?.x"));
        ...
        // assertEquals(null, exec("com.colasoft.opensearch.painless.FeatureTestObject a = null; return a?.x")); // Read field
        // assertEquals(null, exec("com.colasoft.opensearch.painless.FeatureTestObject a = null; a?.x = 7; return a?.x")); // Write field
