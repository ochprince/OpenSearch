...
import com.colasoft.opensearch.painless.spi.annotation.DeprecatedAnnotation;
import com.colasoft.opensearch.painless.spi.annotation.NoImportAnnotation;
import com.colasoft.opensearch.painless.spi.annotation.WhitelistAnnotationParser;
...
public class WhitelistLoaderTests extends ScriptTestCase {
    public void testUnknownAnnotations() {
        ...
        RuntimeException expected = expectThrows(RuntimeException.class, () -> {
            WhitelistLoader.loadFromResourceFiles(Whitelist.class, parsers, "com.colasoft.opensearch.painless.annotation.unknown");
        });
        ...
        expected = expectThrows(RuntimeException.class, () -> {
            WhitelistLoader.loadFromResourceFiles(Whitelist.class, parsers, "com.colasoft.opensearch.painless.annotation.unknown_with_options");
        });
        assertEquals(
    ...
    public void testAnnotations() {
        ...
        Whitelist allowlist = WhitelistLoader.loadFromResourceFiles(Whitelist.class, parsers, "com.colasoft.opensearch.painless.annotation");
