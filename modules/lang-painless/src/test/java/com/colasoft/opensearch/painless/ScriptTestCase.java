...
import com.colasoft.opensearch.painless.antlr.Walker;
...
import static com.colasoft.opensearch.painless.action.PainlessExecuteAction.PainlessTestScript;
...
public abstract class ScriptTestCase extends OpenSearchTestCase {
    ...
    /** Creates a new contexts map with PainlessTextScript = com.colasoft.opensearch.painless.test */
    protected static Map<ScriptContext<?>, List<Whitelist>> newDefaultContexts() {
        ...
        allowlists.add(WhitelistLoader.loadFromResourceFiles(Whitelist.class, "com.colasoft.opensearch.painless.test"));
