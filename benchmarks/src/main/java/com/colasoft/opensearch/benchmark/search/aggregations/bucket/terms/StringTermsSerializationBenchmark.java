...
package com.colasoft.opensearch.benchmark.search.aggregations.bucket.terms;

import org.apache.lucene.util.BytesRef;
import com.colasoft.opensearch.common.io.stream.DelayableWriteable;
...
public class StringTermsSerializationBenchmark {
    ...
    public void initResults() {
        results = DelayableWriteable.referencing(InternalAggregations.from(com.colasoft.opensearch.common.collect.List.of(newTerms(true))));
    }
    ...
    private StringTerms newTerms(boolean withNested) {
        ...
        for (int i = 0; i < buckets; i++) {
            InternalAggregations inner = withNested
                ? InternalAggregations.from(com.colasoft.opensearch.common.collect.List.of(newTerms(false)))
