...
public class MockLogAppender extends AbstractAppender implements AutoCloseable {
    ...
    private static final String COMMON_PREFIX = System.getProperty("opensearch.logger.prefix", "com.colasoft.opensearch.");
    ...
    private static String getLoggerName(String name) {
        if (name.startsWith("com.colasoft.opensearch.")) {
            name = name.substring("com.colasoft.opensearch.".length());
        }
