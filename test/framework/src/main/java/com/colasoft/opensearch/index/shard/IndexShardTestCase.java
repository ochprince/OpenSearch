...
import com.colasoft.opensearch.cluster.routing.ShardRoutingHelper;
...
import com.colasoft.opensearch.common.blobstore.fs.FsBlobContainer;
import com.colasoft.opensearch.common.blobstore.fs.FsBlobStore;
...
import com.colasoft.opensearch.index.MapperTestUtils;
import com.colasoft.opensearch.index.VersionType;
import com.colasoft.opensearch.index.cache.IndexCache;
import com.colasoft.opensearch.index.cache.query.DisabledQueryCache;
...
import com.colasoft.opensearch.index.engine.EngineTestCase;
...
import com.colasoft.opensearch.index.replication.TestReplicationSource;
...
import com.colasoft.opensearch.index.store.RemoteDirectory;
...
import com.colasoft.opensearch.indices.recovery.AsyncRecoveryTarget;
...
import com.colasoft.opensearch.indices.recovery.RecoveryResponse;
import com.colasoft.opensearch.indices.recovery.RecoverySettings;
import com.colasoft.opensearch.indices.recovery.RecoverySourceHandler;
import com.colasoft.opensearch.indices.recovery.RecoverySourceHandlerFactory;
...
import com.colasoft.opensearch.indices.recovery.StartRecoveryRequest;
...
import com.colasoft.opensearch.indices.replication.SegmentReplicationTarget;
...
import com.colasoft.opensearch.repositories.blobstore.OpenSearchBlobStoreRepositoryIntegTestCase;
import com.colasoft.opensearch.snapshots.Snapshot;
import com.colasoft.opensearch.test.DummyShardLock;
