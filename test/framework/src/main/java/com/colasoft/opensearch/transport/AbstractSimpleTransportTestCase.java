...
import static com.colasoft.opensearch.transport.TransportHandshaker.V_3_0_0;
...
public abstract class AbstractSimpleTransportTestCase extends OpenSearchTestCase {
    ...
    @TestLogging(value = "com.colasoft.opensearch.transport.TransportService.tracer:trace", reason = "to ensure we log network events on TRACE level")
    public void testTracerLog() throws Exception {
        ...
        final Logger logger = LogManager.getLogger("com.colasoft.opensearch.transport.TransportService.tracer");
        try (MockLogAppender appender = MockLogAppender.createForLoggers(logger)) {
            ...
            final MockLogAppender.LoggingExpectation requestSentExpectation = new MockLogAppender.PatternSeenEventExpectation(
                "sent request",
                "com.colasoft.opensearch.transport.TransportService.tracer",
                Level.TRACE,
                requestSent
            );
