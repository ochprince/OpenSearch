...
import com.colasoft.opensearch.bootstrap.BootstrapForTesting;
...
import com.colasoft.opensearch.common.io.PathUtilsForTesting;
import com.colasoft.opensearch.common.io.stream.BytesStreamOutput;
import com.colasoft.opensearch.common.io.stream.NamedWriteable;
...
import com.colasoft.opensearch.common.joda.JodaDeprecationPatterns;
import com.colasoft.opensearch.common.logging.DeprecatedMessage;
import com.colasoft.opensearch.common.logging.HeaderWarning;
import com.colasoft.opensearch.common.logging.HeaderWarningAppender;
import com.colasoft.opensearch.common.logging.LogConfigurator;
...
import com.colasoft.opensearch.common.time.FormatNames;
...
import com.colasoft.opensearch.test.junit.listeners.LoggingListener;
import com.colasoft.opensearch.test.junit.listeners.ReproduceInfoPrinter;
...
public abstract class OpenSearchTestCase extends LuceneTestCase {
    ...
    public void setHeaderWarningAppender() {
        ...
        Loggers.addAppender(LogManager.getLogger("com.colasoft.opensearch.deprecation"), this.headerWarningAppender);
    }

    @After
    public void removeHeaderWarningAppender() {
        if (this.headerWarningAppender != null) {
            Loggers.removeAppender(LogManager.getLogger("com.colasoft.opensearch.deprecation"), this.headerWarningAppender);
