...
import com.colasoft.opensearch.common.network.IfConfig;
import com.colasoft.opensearch.common.network.NetworkAddress;
import com.colasoft.opensearch.common.settings.Settings;
import com.colasoft.opensearch.mockito.plugin.PriviledgedMockMaker;
import com.colasoft.opensearch.plugins.PluginInfo;
import com.colasoft.opensearch.secure_sm.SecureSM;
    ...
    static {
        ...
        if (systemPropertyAsBoolean("tests.security.manager", true)) {
            try {
                ...
                addClassCodebase(codebases, "opensearch", "com.colasoft.opensearch.plugins.PluginsService");
                if (System.getProperty("tests.gradle") == null) {
                    // intellij and eclipse don't package our internal libs, so we need to set the codebases for them manually
                    addClassCodebase(codebases, "plugin-classloader", "com.colasoft.opensearch.plugins.ExtendedPluginsClassLoader");
                    addClassCodebase(codebases, "opensearch-nio", "com.colasoft.opensearch.nio.ChannelFactory");
                    addClassCodebase(codebases, "opensearch-secure-sm", "com.colasoft.opensearch.secure_sm.SecureSM");
                    addClassCodebase(codebases, "opensearch-rest-client", "com.colasoft.opensearch.client.RestClient");
                }
