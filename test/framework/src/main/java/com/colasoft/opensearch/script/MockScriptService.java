    ...
    public static <T> MockScriptService singleContext(
        ...
        ScriptEngine engine = new ScriptEngine() {
            ...
            public Set<ScriptContext<?>> getSupportedContexts() {
                return com.colasoft.opensearch.common.collect.Set.of(context);
            }
        };
        return new MockScriptService(
            Settings.EMPTY,
            com.colasoft.opensearch.common.collect.Map.of("lang", engine),
            com.colasoft.opensearch.common.collect.Map.of(context.name, context)
        ) {
            @Override
