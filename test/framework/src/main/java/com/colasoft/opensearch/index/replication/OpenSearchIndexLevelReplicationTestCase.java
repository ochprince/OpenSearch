...
import com.colasoft.opensearch.action.bulk.BulkShardResponse;
import com.colasoft.opensearch.action.bulk.MappingUpdatePerformer;
...
import com.colasoft.opensearch.action.resync.ResyncReplicationRequest;
import com.colasoft.opensearch.action.resync.ResyncReplicationResponse;
...
import com.colasoft.opensearch.action.support.replication.FanoutReplicationProxy;
...
import com.colasoft.opensearch.action.support.replication.TransportReplicationAction.ReplicaResponse;
import com.colasoft.opensearch.action.support.replication.TransportWriteAction;
import com.colasoft.opensearch.action.support.replication.TransportWriteActionTestHelper;
...
import com.colasoft.opensearch.common.collect.Iterators;
...
public abstract class OpenSearchIndexLevelReplicationTestCase extends IndexShardTestCase {
    ...
    protected abstract class ReplicationAction<
        ...
        class PrimaryRef implements ReplicationOperation.Primary<Request, ReplicaRequest, PrimaryResult> {
            ...
            @Override
            public com.colasoft.opensearch.index.shard.ReplicationGroup getReplicationGroup() {
