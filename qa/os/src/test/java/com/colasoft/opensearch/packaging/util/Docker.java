...
import static com.colasoft.opensearch.packaging.util.FileMatcher.p770;
import static com.colasoft.opensearch.packaging.util.FileMatcher.p775;
    ...
    public static void waitForOpenSearchToStart() {
        ...
        do {
            try {
                ...
                if (psOutput.contains("com.colasoft.opensearch.bootstrap.OpenSearch")) {
