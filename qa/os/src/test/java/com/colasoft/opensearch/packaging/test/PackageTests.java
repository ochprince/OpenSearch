...
package com.colasoft.opensearch.packaging.test;

import org.apache.http.client.fluent.Request;
import com.colasoft.opensearch.packaging.util.FileUtils;
import com.colasoft.opensearch.packaging.util.Packages;
import com.colasoft.opensearch.packaging.util.Shell.Result;
...
import static com.colasoft.opensearch.packaging.util.FileExistenceMatchers.fileDoesNotExist;
import static com.colasoft.opensearch.packaging.util.FileExistenceMatchers.fileExists;
import static com.colasoft.opensearch.packaging.util.FileUtils.append;
import static com.colasoft.opensearch.packaging.util.FileUtils.assertPathsDoNotExist;
import static com.colasoft.opensearch.packaging.util.FileUtils.assertPathsExist;
import static com.colasoft.opensearch.packaging.util.FileUtils.fileWithGlobExist;
import static com.colasoft.opensearch.packaging.util.FileUtils.mv;
import static com.colasoft.opensearch.packaging.util.FileUtils.rm;
import static com.colasoft.opensearch.packaging.util.FileUtils.slurp;
import static com.colasoft.opensearch.packaging.util.Packages.SYSTEMD_SERVICE;
import static com.colasoft.opensearch.packaging.util.Packages.assertInstalled;
import static com.colasoft.opensearch.packaging.util.Packages.assertRemoved;
import static com.colasoft.opensearch.packaging.util.Packages.installPackage;
import static com.colasoft.opensearch.packaging.util.Packages.remove;
import static com.colasoft.opensearch.packaging.util.Packages.restartOpenSearch;
import static com.colasoft.opensearch.packaging.util.Packages.verifyPackageInstallation;
import static com.colasoft.opensearch.packaging.util.Platforms.getOsRelease;
import static com.colasoft.opensearch.packaging.util.Platforms.isSystemd;
import static com.colasoft.opensearch.packaging.util.ServerUtils.makeRequest;
import static com.colasoft.opensearch.packaging.util.ServerUtils.runOpenSearchTests;
...
public class PackageTests extends PackagingTestCase {
    ...
    public void test31InstallDoesNotStartServer() {
        assertThat(sh.run("ps aux").stdout, not(containsString("com.colasoft.opensearch.bootstrap.OpenSearch")));
    }
