...
import static com.colasoft.opensearch.packaging.test.PackagingTestCase.getRootTempDir;
...
import static com.colasoft.opensearch.packaging.util.Platforms.isRPM;
...
public class Cleanup {
    ...
    public static void cleanEverything() throws Exception {
        ...
        Platforms.onLinux(() -> {
            ...
            sh.runIgnoreExitCode("ps aux | grep -i 'com.colasoft.opensearch.bootstrap.OpenSearch' | awk {'print $2'} | xargs kill -9");
        });
        ...
        Platforms.onWindows(() -> {
            ...
            sh.runIgnoreExitCode(
                "Get-WmiObject Win32_Process | "
                    + "Where-Object { $_.CommandLine -Match 'com.colasoft.opensearch.bootstrap.OpenSearch' } | "
