...
import com.colasoft.opensearch.client.tasks.GetTaskRequest;
import com.colasoft.opensearch.client.tasks.GetTaskResponse;
...
public class TasksIT extends OpenSearchRestHighLevelClientTestCase {
    ...
    public void testListTasks() throws IOException {
        ...
        for (TaskGroup taskGroup : response.getTaskGroups()) {
            com.colasoft.opensearch.tasks.TaskInfo parent = taskGroup.getTaskInfo();
            if ("cluster:monitor/tasks/lists".equals(parent.getAction())) {
                ...
                com.colasoft.opensearch.tasks.TaskInfo child = childGroup.getTaskInfo();
    ...
    public void testGetValidTask() throws Exception {
        ...
        com.colasoft.opensearch.tasks.TaskInfo info = taskResponse.getTaskInfo();
    ...
    public void testCancelTasks() throws IOException {
        ...
        com.colasoft.opensearch.tasks.TaskInfo firstTask = listResponse.getTasks().get(0);
