...
import com.colasoft.opensearch.action.admin.indices.datastream.GetDataStreamAction.Response.DataStreamInfo;
...
public class GetDataStreamResponseTests extends AbstractResponseTestCase<GetDataStreamAction.Response, GetDataStreamResponse> {
    ...
    protected void assertInstances(GetDataStreamAction.Response serverTestInstance, GetDataStreamResponse clientInstance) {
        ...
        Iterator<com.colasoft.opensearch.client.indices.DataStream> clientIt = clientInstance.getDataStreams().iterator();
        while (serverIt.hasNext()) {
            com.colasoft.opensearch.client.indices.DataStream client = clientIt.next();
