...
public class TasksRequestConvertersTests extends OpenSearchTestCase {
    ...
    public void testCancelTasks() {
        ...
        com.colasoft.opensearch.client.tasks.TaskId taskId = new com.colasoft.opensearch.client.tasks.TaskId(randomAlphaOfLength(5), randomNonNegativeLong());
        com.colasoft.opensearch.client.tasks.TaskId parentTaskId = new com.colasoft.opensearch.client.tasks.TaskId(
