...
import com.colasoft.opensearch.client.AbstractRequestTestCase;
...
public class ResizeRequestTests extends AbstractRequestTestCase<ResizeRequest, com.colasoft.opensearch.action.admin.indices.shrink.ResizeRequest> {
    ...
    @Override
    protected com.colasoft.opensearch.action.admin.indices.shrink.ResizeRequest doParseToServerInstance(XContentParser parser) throws IOException {
        com.colasoft.opensearch.action.admin.indices.shrink.ResizeRequest req = new com.colasoft.opensearch.action.admin.indices.shrink.ResizeRequest(
            "target",
            "source"
        );
    ...
    protected void assertInstances(
        com.colasoft.opensearch.action.admin.indices.shrink.ResizeRequest serverInstance,
