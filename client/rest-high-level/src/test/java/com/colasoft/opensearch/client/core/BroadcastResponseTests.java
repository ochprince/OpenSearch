...
public class BroadcastResponseTests extends AbstractResponseTestCase<
    com.colasoft.opensearch.action.support.broadcast.BroadcastResponse,
    BroadcastResponse> {
    ...
    @Override
    protected com.colasoft.opensearch.action.support.broadcast.BroadcastResponse createServerTestInstance(XContentType xContentType) {
        ...
        return new com.colasoft.opensearch.action.support.broadcast.BroadcastResponse(total, successful, failed, failures);
    }
    ...
    protected void assertInstances(
        com.colasoft.opensearch.action.support.broadcast.BroadcastResponse serverTestInstance,
