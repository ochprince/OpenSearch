...
package com.colasoft.opensearch.client.core;
...
public class MainResponseTests extends AbstractResponseTestCase<com.colasoft.opensearch.action.main.MainResponse, MainResponse> {
    @Override
    protected com.colasoft.opensearch.action.main.MainResponse createServerTestInstance(XContentType xContentType) {
        ...
        return new com.colasoft.opensearch.action.main.MainResponse(nodeName, version, clusterName, clusterUuid, build);
    }
    ...
    @Override
    protected void assertInstances(com.colasoft.opensearch.action.main.MainResponse serverTestInstance, MainResponse clientInstance) {
