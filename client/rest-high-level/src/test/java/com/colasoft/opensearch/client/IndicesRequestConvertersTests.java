...
import com.colasoft.opensearch.client.indices.RandomCreateIndexGenerator;
...
import static com.colasoft.opensearch.client.indices.RandomCreateIndexGenerator.randomAliases;
import static com.colasoft.opensearch.client.indices.RandomCreateIndexGenerator.randomMapping;
import static com.colasoft.opensearch.index.RandomCreateIndexGenerator.randomAlias;
import static com.colasoft.opensearch.index.RandomCreateIndexGenerator.randomIndexSettings;
import static com.colasoft.opensearch.index.alias.RandomAliasActionsGenerator.randomAliasAction;
...
public class IndicesRequestConvertersTests extends OpenSearchTestCase {
    ...
    public void testRollover() throws IOException {
        ...
        if (OpenSearchTestCase.randomBoolean()) {
            rolloverRequest.getCreateIndexRequest().settings(com.colasoft.opensearch.index.RandomCreateIndexGenerator.randomIndexSettings());
        }
