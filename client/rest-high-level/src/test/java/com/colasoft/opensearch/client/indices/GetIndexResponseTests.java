...
import com.colasoft.opensearch.client.GetAliasesResponseTests;
...
public class GetIndexResponseTests extends AbstractResponseTestCase<
    com.colasoft.opensearch.action.admin.indices.get.GetIndexResponse,
    GetIndexResponse> {

    @Override
    protected com.colasoft.opensearch.action.admin.indices.get.GetIndexResponse createServerTestInstance(XContentType xContentType) {
        ...
        return new com.colasoft.opensearch.action.admin.indices.get.GetIndexResponse(
            indices,
            mappings.build(),
            aliases.build(),
            settings.build(),
    ...
    protected void assertInstances(
        com.colasoft.opensearch.action.admin.indices.get.GetIndexResponse serverTestInstance,
