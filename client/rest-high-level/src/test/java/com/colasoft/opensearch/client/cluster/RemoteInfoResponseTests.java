...
package com.colasoft.opensearch.client.cluster;
...
import com.colasoft.opensearch.transport.RemoteConnectionInfo;
...
public class RemoteInfoResponseTests extends AbstractResponseTestCase<
    com.colasoft.opensearch.action.admin.cluster.remote.RemoteInfoResponse,
    RemoteInfoResponse> {

    @Override
    protected com.colasoft.opensearch.action.admin.cluster.remote.RemoteInfoResponse createServerTestInstance(XContentType xContentType) {
        ...
        return new com.colasoft.opensearch.action.admin.cluster.remote.RemoteInfoResponse(remoteInfos);
    }
    ...
    protected void assertInstances(
        com.colasoft.opensearch.action.admin.cluster.remote.RemoteInfoResponse serverTestInstance,
        ...
        for (com.colasoft.opensearch.client.cluster.RemoteConnectionInfo clientRemoteInfo : clientInstance.getInfos()) {
