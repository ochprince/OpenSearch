...
public class ResizeResponseTests extends AbstractResponseTestCase<
    com.colasoft.opensearch.action.admin.indices.shrink.ResizeResponse,
    ResizeResponse> {

    @Override
    protected com.colasoft.opensearch.action.admin.indices.shrink.ResizeResponse createServerTestInstance(XContentType xContentType) {
        boolean acked = randomBoolean();
        return new com.colasoft.opensearch.action.admin.indices.shrink.ResizeResponse(acked, acked, randomAlphaOfLength(5));
    }
    ...
    protected void assertInstances(
        com.colasoft.opensearch.action.admin.indices.shrink.ResizeResponse serverTestInstance,
