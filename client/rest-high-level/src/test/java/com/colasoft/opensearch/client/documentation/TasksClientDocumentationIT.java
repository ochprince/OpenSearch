...
import com.colasoft.opensearch.action.admin.cluster.node.tasks.list.TaskGroup;
...
import com.colasoft.opensearch.client.tasks.CancelTasksRequest;
import com.colasoft.opensearch.client.tasks.CancelTasksResponse;
...
public class TasksClientDocumentationIT extends OpenSearchRestHighLevelClientTestCase {
    ...
    public void testCancelTasks() throws IOException {
        RestHighLevelClient client = highLevelClient();
        {
            ...
            CancelTasksRequest request = new com.colasoft.opensearch.client.tasks.CancelTasksRequest.Builder()
            ...
            CancelTasksRequest byTaskIdRequest = new com.colasoft.opensearch.client.tasks.CancelTasksRequest.Builder() // <1>
                .withTaskId(new com.colasoft.opensearch.client.tasks.TaskId("myNode",44L)) // <2>
        ...
        CancelTasksRequest request = new com.colasoft.opensearch.client.tasks.CancelTasksRequest.Builder().build();
        ...
        List<com.colasoft.opensearch.client.tasks.TaskInfo> tasks = response.getTasks(); // <1>
        // end::cancel-tasks-response-tasks

        // tag::cancel-tasks-response-calc
        Map<String, List<com.colasoft.opensearch.client.tasks.TaskInfo>> perNodeTasks = response.getPerNodeTasks(); // <1>
        List<com.colasoft.opensearch.client.tasks.TaskGroup> groups = response.getTaskGroups(); // <2>
        // end::cancel-tasks-response-calc

        // tag::cancel-tasks-response-failures
        List<com.colasoft.opensearch.client.tasks.OpenSearchException> nodeFailures = response.getNodeFailures(); // <1>
        List<com.colasoft.opensearch.client.tasks.TaskOperationFailure> taskFailures = response.getTaskFailures(); // <2>
