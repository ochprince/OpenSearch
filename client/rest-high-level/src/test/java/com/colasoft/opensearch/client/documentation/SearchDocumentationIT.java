...
import com.colasoft.opensearch.client.core.CountResponse;
...
import com.colasoft.opensearch.common.text.Text;
...
import com.colasoft.opensearch.index.rankeval.EvalQueryQuality;
import com.colasoft.opensearch.index.rankeval.EvaluationMetric;
import com.colasoft.opensearch.index.rankeval.MetricDetail;
import com.colasoft.opensearch.index.rankeval.PrecisionAtK;
import com.colasoft.opensearch.index.rankeval.RankEvalRequest;
import com.colasoft.opensearch.index.rankeval.RankEvalResponse;
import com.colasoft.opensearch.index.rankeval.RankEvalSpec;
import com.colasoft.opensearch.index.rankeval.RatedDocument;
import com.colasoft.opensearch.index.rankeval.RatedRequest;
import com.colasoft.opensearch.index.rankeval.RatedSearchHit;
...
import com.colasoft.opensearch.script.mustache.MultiSearchTemplateResponse;
import com.colasoft.opensearch.script.mustache.MultiSearchTemplateResponse.Item;
import com.colasoft.opensearch.script.mustache.SearchTemplateRequest;
import com.colasoft.opensearch.script.mustache.SearchTemplateResponse;
...
import com.colasoft.opensearch.search.fetch.subphase.highlight.HighlightField;
import com.colasoft.opensearch.search.profile.ProfileResult;
import com.colasoft.opensearch.search.profile.ProfileShardResult;
import com.colasoft.opensearch.search.profile.aggregation.AggregationProfileShardResult;
import com.colasoft.opensearch.search.profile.query.CollectorResult;
import com.colasoft.opensearch.search.profile.query.QueryProfileShardResult;
...
import com.colasoft.opensearch.search.suggest.SuggestBuilders;
        ...
        }
        {
            ...
            SearchResponse searchResponse = client.search(searchRequest, RequestOptions.DEFAULT);
            {
                ...
                try {
                    ...
                    assertThat(message, containsString("com.colasoft.opensearch.search.aggregations.bucket.terms.ParsedStringTerms"));
                    assertThat(message, containsString("com.colasoft.opensearch.search.aggregations.bucket.range.Range"));
                }
