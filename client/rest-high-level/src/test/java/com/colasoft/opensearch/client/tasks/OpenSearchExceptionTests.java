...
public class OpenSearchExceptionTests extends AbstractResponseTestCase<
    com.colasoft.opensearch.OpenSearchException,
    com.colasoft.opensearch.client.tasks.OpenSearchException> {

    @Override
    protected com.colasoft.opensearch.OpenSearchException createServerTestInstance(XContentType xContentType) {
        ...
        com.colasoft.opensearch.OpenSearchException exception = new com.colasoft.opensearch.OpenSearchException("elastic_exception", iae);
    ...
    @Override
    protected void assertInstances(com.colasoft.opensearch.OpenSearchException serverTestInstance, OpenSearchException clientInstance) {
