...
public class RandomCreateIndexGenerator {
    ...
    public static CreateIndexRequest randomCreateIndexRequest() {
        try {
            ...
            com.colasoft.opensearch.action.admin.indices.create.CreateIndexRequest serverRequest = com.colasoft.opensearch.index.RandomCreateIndexGenerator
    ...
    public static XContentBuilder randomMapping() throws IOException {
        ...
        builder.startObject();
        com.colasoft.opensearch.index.RandomCreateIndexGenerator.randomMappingFields(builder, true);
        builder.endObject();
        return builder;
    }
