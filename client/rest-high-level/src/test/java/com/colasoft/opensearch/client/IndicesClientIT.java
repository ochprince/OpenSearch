...
import com.colasoft.opensearch.action.admin.indices.shrink.ResizeType;
...
import com.colasoft.opensearch.client.indices.AnalyzeRequest;
import com.colasoft.opensearch.client.indices.AnalyzeResponse;
import com.colasoft.opensearch.client.indices.CloseIndexRequest;
import com.colasoft.opensearch.client.indices.CloseIndexResponse;
import com.colasoft.opensearch.client.indices.ComposableIndexTemplateExistRequest;
import com.colasoft.opensearch.client.indices.CreateDataStreamRequest;
import com.colasoft.opensearch.client.indices.CreateIndexRequest;
import com.colasoft.opensearch.client.indices.CreateIndexResponse;
import com.colasoft.opensearch.client.indices.DataStream;
import com.colasoft.opensearch.client.indices.DataStreamsStatsRequest;
import com.colasoft.opensearch.client.indices.DataStreamsStatsResponse;
import com.colasoft.opensearch.client.indices.DataStreamsStatsResponse.DataStreamStats;
import com.colasoft.opensearch.client.indices.DeleteAliasRequest;
import com.colasoft.opensearch.client.indices.DeleteComposableIndexTemplateRequest;
import com.colasoft.opensearch.client.indices.DeleteDataStreamRequest;
import com.colasoft.opensearch.client.indices.GetComposableIndexTemplateRequest;
import com.colasoft.opensearch.client.indices.GetComposableIndexTemplatesResponse;
import com.colasoft.opensearch.client.indices.GetDataStreamRequest;
import com.colasoft.opensearch.client.indices.GetDataStreamResponse;
import com.colasoft.opensearch.client.indices.GetFieldMappingsRequest;
import com.colasoft.opensearch.client.indices.GetFieldMappingsResponse;
import com.colasoft.opensearch.client.indices.GetIndexRequest;
import com.colasoft.opensearch.client.indices.GetIndexResponse;
import com.colasoft.opensearch.client.indices.GetIndexTemplatesRequest;
import com.colasoft.opensearch.client.indices.GetIndexTemplatesResponse;
import com.colasoft.opensearch.client.indices.GetMappingsRequest;
import com.colasoft.opensearch.client.indices.GetMappingsResponse;
import com.colasoft.opensearch.client.indices.IndexTemplateMetadata;
import com.colasoft.opensearch.client.indices.IndexTemplatesExistRequest;
import com.colasoft.opensearch.client.indices.PutComposableIndexTemplateRequest;
import com.colasoft.opensearch.client.indices.PutIndexTemplateRequest;
import com.colasoft.opensearch.client.indices.PutMappingRequest;
import com.colasoft.opensearch.client.indices.SimulateIndexTemplateRequest;
import com.colasoft.opensearch.client.indices.SimulateIndexTemplateResponse;
import com.colasoft.opensearch.client.indices.rollover.RolloverRequest;
import com.colasoft.opensearch.client.indices.rollover.RolloverResponse;
...
import com.colasoft.opensearch.cluster.metadata.Template;
...
import static com.colasoft.opensearch.common.xcontent.support.XContentMapValues.extractRawValues;
import static com.colasoft.opensearch.common.xcontent.support.XContentMapValues.extractValue;
...
public class IndicesClientIT extends OpenSearchRestHighLevelClientTestCase {
    ...
    public void testCloseEmptyOrNullIndex() {
        ...
        CloseIndexRequest closeIndexRequest = new CloseIndexRequest(indices);
        com.colasoft.opensearch.client.ValidationException exception = expectThrows(
            com.colasoft.opensearch.client.ValidationException.class,
            () -> execute(closeIndexRequest, highLevelClient().indices()::close, highLevelClient().indices()::closeAsync)
        );
    ...
    public void testShrink() throws IOException {
        ...
        resizeRequest.setTargetIndex(
            new com.colasoft.opensearch.action.admin.indices.create.CreateIndexRequest("target").settings(targetSettings).alias(new Alias("alias"))
        );
    ...
    public void testDeleteAlias() throws IOException {
        ...
        com.colasoft.opensearch.client.core.AcknowledgedResponse aliasDeleteResponse = execute(
            request,
    ...
    public void testSimulateIndexTemplate() throws Exception {
        ...
        CompressedXContent mappings = new CompressedXContent("{\"properties\":{\"host_name\":{\"type\":\"keyword\"}}}");
        AliasMetadata alias = AliasMetadata.builder("alias").writeIndex(true).build();
        Template template = new Template(settings, mappings, com.colasoft.opensearch.common.collect.Map.of("alias", alias));
        List<String> pattern = com.colasoft.opensearch.common.collect.List.of("pattern");
        ComposableIndexTemplate indexTemplate = new ComposableIndexTemplate(
            pattern,
            template,
            Collections.emptyList(),
        ...
        ComposableIndexTemplate simulationTemplate = new ComposableIndexTemplate(
            pattern,
            new Template(null, null, com.colasoft.opensearch.common.collect.Map.of("simulation-alias", simulationAlias)),
            Collections.emptyList(),
            2L,
            1L,
            new HashMap<>(),
