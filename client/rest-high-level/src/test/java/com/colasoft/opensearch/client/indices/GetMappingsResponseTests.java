...
public class GetMappingsResponseTests extends AbstractResponseTestCase<
    com.colasoft.opensearch.action.admin.indices.mapping.get.GetMappingsResponse,
    GetMappingsResponse> {

    @Override
    protected com.colasoft.opensearch.action.admin.indices.mapping.get.GetMappingsResponse createServerTestInstance(XContentType xContentType) {
        ...
        return new com.colasoft.opensearch.action.admin.indices.mapping.get.GetMappingsResponse(mappings.build());
    }
    ...
    protected void assertInstances(
        com.colasoft.opensearch.action.admin.indices.mapping.get.GetMappingsResponse serverTestInstance,
