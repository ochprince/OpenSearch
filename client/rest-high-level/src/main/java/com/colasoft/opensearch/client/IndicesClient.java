...
import com.colasoft.opensearch.client.indices.ResizeRequest;
import com.colasoft.opensearch.client.indices.ResizeResponse;
...
public final class IndicesClient {
     ...
     */
    @Deprecated
    public com.colasoft.opensearch.action.admin.indices.shrink.ResizeResponse shrink(
        com.colasoft.opensearch.action.admin.indices.shrink.ResizeRequest resizeRequest,
        RequestOptions options
    ) throws IOException {
        return restHighLevelClient.performRequestAndParseEntity(
            resizeRequest,
            IndicesRequestConverters::shrink,
            options,
            com.colasoft.opensearch.action.admin.indices.shrink.ResizeResponse::fromXContent,
            emptySet()
        );
    }
    ...
    public Cancellable shrinkAsync(
        com.colasoft.opensearch.action.admin.indices.shrink.ResizeRequest resizeRequest,
        RequestOptions options,
        ActionListener<com.colasoft.opensearch.action.admin.indices.shrink.ResizeResponse> listener
    ) {
        return restHighLevelClient.performRequestAsyncAndParseEntity(
            resizeRequest,
            IndicesRequestConverters::shrink,
     ...
     */
    @Deprecated
    public com.colasoft.opensearch.action.admin.indices.shrink.ResizeResponse split(
        com.colasoft.opensearch.action.admin.indices.shrink.ResizeRequest resizeRequest,
        RequestOptions options
    ) throws IOException {
        return restHighLevelClient.performRequestAndParseEntity(
     ...
     */
    @Deprecated
    public com.colasoft.opensearch.action.admin.indices.shrink.ResizeResponse clone(
        com.colasoft.opensearch.action.admin.indices.shrink.ResizeRequest resizeRequest,
        RequestOptions options
    ) throws IOException {
        return restHighLevelClient.performRequestAndParseEntity(
     ...
     * @param options the request options (e.g. headers), use {@link RequestOptions#DEFAULT} if nothing needs to be customized
     */
    public com.colasoft.opensearch.client.core.AcknowledgedResponse deleteAlias(DeleteAliasRequest request, RequestOptions options)
        throws IOException {
        return restHighLevelClient.performRequestAndParseEntity(
            request,
            IndicesRequestConverters::deleteAlias,
            options,
            com.colasoft.opensearch.client.core.AcknowledgedResponse::fromXContent,
            emptySet()
        );
    }
    ...
    public Cancellable deleteAliasAsync(
        ...
        RequestOptions options,
        ActionListener<com.colasoft.opensearch.client.core.AcknowledgedResponse> listener
    ) {
        return restHighLevelClient.performRequestAsyncAndParseEntity(
            request,
            IndicesRequestConverters::deleteAlias,
