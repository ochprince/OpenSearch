...
import com.colasoft.opensearch.client.tasks.TaskId;
...
final class RequestConverters {
    ...
    static void addSearchRequestParams(Params params, SearchRequest searchRequest) {
         ...
         * refer to com.colasoft.opensearch.action.search.SearchResponseMerger
         */
        if (searchRequest.pointInTimeBuilder() != null) {
    ...
    static class Params {
        ...
        Params withTaskId(com.colasoft.opensearch.tasks.TaskId taskId) {
        ...
        Params withParentTaskId(com.colasoft.opensearch.tasks.TaskId parentTaskId) {
