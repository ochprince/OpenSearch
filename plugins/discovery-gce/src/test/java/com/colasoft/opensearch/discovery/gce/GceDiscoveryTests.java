 ...
 * for a given project-id and zone under the src/test/resources/com/colasoft/opensearch/discovery/gce with dir name:
 *
 ...
 *  .build();
 *
 *  You need to create a file under `src/test/resources/com/colasoft/opensearch/discovery/gce/` named:
 *
