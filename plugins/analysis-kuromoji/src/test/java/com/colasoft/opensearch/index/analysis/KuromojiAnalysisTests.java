...
import com.colasoft.opensearch.plugin.analysis.kuromoji.AnalysisKuromojiPlugin;
...
public class KuromojiAnalysisTests extends OpenSearchTestCase {
    ...
    private static TestAnalysis createTestAnalysis() throws IOException {
        ...
        String json = "/com/colasoft/opensearch/index/analysis/kuromoji_analysis.json";
