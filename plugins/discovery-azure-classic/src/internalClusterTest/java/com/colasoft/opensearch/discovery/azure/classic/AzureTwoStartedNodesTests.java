...
import com.colasoft.opensearch.cloud.azure.classic.AbstractAzureComputeServiceTestCase;
...
public class AzureTwoStartedNodesTests extends AbstractAzureComputeServiceTestCase {
    ...
    public void testTwoNodesShouldRunUsingPrivateOrPublicIp() {
        final String hostType = randomFrom(com.colasoft.opensearch.discovery.azure.classic.AzureSeedHostsProvider.HostType.values()).getType();
